...
| Команда | Описание |
|:----------------  |:-------------|
| `teamsfx account login <service>`  | Вход в выбранную облачную службу. Параметры службы Microsoft 365 Azure. |
| `teamsfx account logout <service>`  | Выход из выбранной облачной службы. Параметры службы Microsoft 365 Azure. |
...
* Рабочий процесс совместной работы E2E в CLI
  ...
  * Как участник совместной работы над проектом:
    ...
    * Войдите в Microsoft 365 учетной записи. Убедитесь, что добавлена та же учетная запись Microsoft 365:
