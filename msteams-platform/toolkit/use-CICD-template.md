...
title: Шаблоны CI/CD
author: MuyangAmigo
description: В этом модуле вы узнаете, как использовать шаблоны конвейеров CI/CD в GitHub, Azure DevOps и Jenkins для шаблонов Teams Application DevelopersCI/CD.
ms.author: ruhe
...
1. **Щелкните значок Набора средств** :::image type="icon" source="../assets/images/teams-toolkit-v2/add-API/api-add-icon.png"::: Teams на левой панели.

1. Выбор **параметра "Добавить компоненты"**

   :::image type="content" source="../assets/images/teams-toolkit-v2/add-feature.png" alt-text="Добавление функции":::

1. Выберите **Добавить рабочие процессы CI/CD.**.

   :::image type="content" source="../assets/images/teams-toolkit-v2/toolkit-ci-cd-workflow.png" alt-text="Выбор рабочего процесса CI/CD":::
...
1. Создание нового проекта приложения Teams с помощью Teams Toolkit.
2. **Щелкните значок Набора средств** :::image type="icon" source="../assets/images/teams-toolkit-v2/add-API/api-add-icon.png"::: Teams на левой панели.
1. Выберите **Добавить рабочие процессы CI/CD.**.
1. Выберите среду из командной строки.
1. Выберите **Azure DevOps** в качестве поставщика CI/CD.
1. Выберите хотя бы один шаблон из следующих вариантов: CI, CD, Provision и Publish to Teams.
1. Откройте шаблон и настройте рабочие процессы, соответствующие сценариям.
1. Следуйте файлам README в разделе `.azure/pipelines`, чтобы настроить рабочий процесс в Azure DevOps.
