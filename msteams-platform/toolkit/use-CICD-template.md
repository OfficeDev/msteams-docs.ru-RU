...
|---|---|
|[TeamsFx-CLI-Action](https://github.com/OfficeDev/teamsfx-cli-action)|GitHub, которое интегрируется с CLI TeamsFx.|
...
Вы можете создать следующие шаблоны рабочих процессов с помощью GitHub:

**Набор инструментов Teams в Visual Studio Code**

1. Создание нового проекта приложения Teams с помощью Teams Toolkit.
1. Выберите Teams :::image type="icon" source="../assets/images/teams-toolkit-v2/add-API/api-add-icon.png" alt-text="значок API"::: значка **toolkit** на панели навигации слева.
...
Вы можете создать следующие шаблоны рабочих процессов с помощью Azure DevOps:

**Набор инструментов Teams в Visual Studio Code**

1. Создание нового проекта приложения Teams с помощью Teams Toolkit.
2. Выберите Teams :::image type="icon" source="../assets/images/teams-toolkit-v2/add-API/api-add-icon.png" alt-text="значок API"::: значка **toolkit** на панели навигации слева.
...
1. Войдите на портал [разработчика Teams с помощью](https://dev.teams.microsoft.com) соответствующей учетной записи.
