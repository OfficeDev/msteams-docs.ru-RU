...
ms.locfileid: "66503370"
---
# <a name="provision-cloud-resources-using-teams-toolkit"></a>Подготовка облачных ресурсов с помощью Набора средств Teams
...
* Необходимые условия, касающиеся учетных записей. Для подготовки облачных ресурсов необходимо иметь следующие учетные записи:
  ...
  * Учетная запись Microsoft 365 с действительной подпиской.
  * Azure с действительной подпиской.
  Дополнительные сведения см. [в статье о подготовке учетных записей для создания приложения Teams](accounts.md).
