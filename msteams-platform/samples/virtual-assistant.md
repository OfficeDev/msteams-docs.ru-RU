...
В следующем примере показано, как преобразовать шаблон приложения book-a-room в навык Виртуальный помощник: Book-a-room — это Teams, который позволяет пользователям быстро находить и резервировать конференц-зал на 30, 60 или 90 минут, начиная с текущего времени. Длительность резервирования по умолчанию — 30 минут. Бот "Резервирование комнаты" действует в области личных или приватных бесед.
