...
Далее `SkillCardActionData` класс в Виртуальный помощник вводится для извлечения из полезной нагрузки действия `skillId` карты.
