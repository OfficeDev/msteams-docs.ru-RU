...
Power Virtual Agent — это решение без кода с управляемым графическим интерфейсом. Оно создано на платформе Microsoft Power и Bot Framework. Интерактивное решение графического интерфейса без необходимости создания программного кода позволяет каждому участнику вашей команды создавать многофункциональные чат-боты для бесед, легко интегрирующиеся с платформой Teams. Вы можете проектировать, разрабатывать и публиковать интеллектуальные виртуальные агенты для Teams без настройки среды разработки, создания веб-службы или непосредственной регистрации в Bot Framework.
...
Сторонние веб-сайты могут использовать сценарий запуска для встраивания кнопок «Отправить в Teams» на свои веб-страницы. Эта кнопка запускает функцию «Отправить в Teams» во всплывающем окне. Она позволяет делиться ссылкой непосредственно с любым пользователем или каналом Microsoft Teams без переключения контекста.
...
* [Люди выбора](~/concepts/device-capabilities/people-picker-capability.md)
