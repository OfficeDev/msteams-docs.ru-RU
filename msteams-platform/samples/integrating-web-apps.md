...
1. [Определите точки входа вашего приложения.](../concepts/extensibility-points.md) Это для личного использования, для совместной работы или для обоих?
...
API и структуры данных вашего приложения должны поддерживать приложение при интеграции с Teams. Чтобы расширить поддержку, необходимо дополнить API и структуры данных контекстной информацией [](../concepts/build-and-test/deep-links.md)о Teams для сопоставления удостоверений, [](../concepts/authentication/configure-identity-provider.md)поддержки глубоких ссылок и включения Microsoft [Graph](/graph/teams-concept-overview).
...
Azure Active Directory является поставщиком удостоверений для Teams. Если в вашем приложении используется другой поставщик удостоверений, необходимо либо сделать упражнение сопоставления удостоверений, либо объединить его с Azure AD.
