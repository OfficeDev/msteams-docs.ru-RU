...
> [!NOTE]
> Ресурс регистрации каналов ботов будет показывать **глобальный** регион, даже если вы выбрали Западный США. Так и должно быть.
...
Чтобы войти в пример бота, необходимо настроить Emulator.
...
1. В Emulator выберите значок передачи &#9881; в левом нижнем  Emulator Параметры или вкладку Emulator Параметры в правом верхнем.
...
1. Проверьте поле run **ngrok при** запуске Emulator.
1. Выберите **кнопку Сохранить.**

Когда бот отображает карточку регистрации и пользователь выбирает кнопку вход, Emulator откроет страницу, которую пользователь может использовать для регистрации с поставщиком проверки подлинности.
...
Для тестирования бота можно использовать студию приложений или портал разработчика.
...
11. Выберите три точки (●●●) на левой панели. Затем выберите значок App Studio.
12. Выберите **вкладку Редактор Манифеста.** Вы должны увидеть значок для загруженного бота.
13. Кроме того, вы должны иметь возможность видеть бота, перечисленных в качестве контакта в списке чата, который можно использовать для обмена сообщениями с ботом.
 
# <a name="developer-portal"></a>[Портал разработчика](#tab/DP)

11. Перейдите на **[портал Разработчик](https://dev.teams.microsoft.com/)**.
12. Выберите **Приложения** на левой панели. Затем выберите **импорт app**.
13. Выберите **функции приложения** и выберите **Bot**. Вы можете увидеть значок для загруженного бота.
14. Кроме того, в списке чатов можно увидеть бота, который можно использовать для обмена сообщениями с ботом.
