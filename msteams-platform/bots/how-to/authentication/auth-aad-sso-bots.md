...
|----------------|-----------------|--------------|
|Bot Framework SDK | Пример использования пакета SDK платформы Bot Framework. |[View](https://github.com/microsoft/BotBuilder-Samples/tree/main/samples/csharp_dotnetcore/46.teams-auth)|

## <a name="step-by-step-guide"></a>Пошаговые инструкции

Следуйте [пошаговым инструкциям](../../../sbs-bots-with-sso.yml), которые помогут вам создать бот с включенной проверкой подлинности для единого входа.
