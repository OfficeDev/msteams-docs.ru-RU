...
> В настоящее время для ✔ поддержки единого входа приложение должно устанавливаться в личной области.
...
## <a name="develop-an-single-sign-on-microsoft-teams-bot"></a>Разработка ленты единого входа Microsoft Teams
...
Этот шаг похож на процесс обработки [последовательности входа в Tab](../../../tabs/how-to/authentication/auth-aad-sso.md) :
