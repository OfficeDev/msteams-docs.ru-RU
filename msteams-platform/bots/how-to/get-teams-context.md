...
Вы также можете получить сведения о конкретном пользователе с помощью Teams, upN или объекта Microsoft Azure Active Directory (Azure AD).
...
При установке в команде бот может запрашивать метаданные об этой группе, включая Microsoft Azure Active Directory группы Azure AD.
