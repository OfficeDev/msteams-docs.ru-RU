...
description: В этом модуле вы узнаете, как приложения Microsoft Teams могут взаимодействовать с пользователями с помощью голосовых и видеофайлов с помощью API Microsoft Graph для звонков и собраний по сети, а также узнать о потоках мультимедиа в режиме реального времени.
ms.topic: conceptual
...
* [Включение события в виде собрания по сети в календаре Outlook](/graph/outlook-calendar-online-meetings?tabs=http)
