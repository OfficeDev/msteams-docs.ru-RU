...
Боты вызовов и сетевых собраний имеют следующие два дополнительных параметра в manifest.js, которые позволяют аудио или видео для вашего бота в Teams.
