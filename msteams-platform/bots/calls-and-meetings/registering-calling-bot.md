...
Для приложений, [использующих](https://portal.azure.com) конечную точку Azure AD V1, администратор клиента может дать согласие на разрешения приложений с помощью портала Microsoft Azure при установке приложения в организации. Кроме того, вы можете предоставить в приложении возможность регистрации, с помощью которой администраторы могут дать согласие на настроенные разрешения. После записи согласия администратора в Azure AD приложение может запрашивать маркеры без повторного запроса согласия.
