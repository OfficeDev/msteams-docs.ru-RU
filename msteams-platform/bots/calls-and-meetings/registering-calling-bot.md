...
Чтобы использовать конечную точку Azure Active Directory V1, необходимо заранее настроить разрешения приложения [](https://aka.ms/aadapplist) для бота с помощью Microsoft Azure [портала](/azure/active-directory/develop/azure-ad-endpoint-comparison).
