...
description: Узнайте, как зарегистрировать нового бота для голосовых и видеозвонок в Microsoft Teams, создать нового бота или добавить возможность вызова, добавить разрешения графа. Пример для создания звонка, присоединения к собранию и передачи звонка.
ms.topic: conceptual
...
| События собраний в реальном времени |В примере приложения показано, как бот может получать события собраний в режиме реального времени.|[View](https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/meetings-events/csharp)|

## <a name="step-by-step-guide"></a>Пошаговые инструкции

Следуйте пошаговому [руководству](../../sbs-calling-and-meeting.yml) , чтобы настроить бота для звонков и собраний Teams.
