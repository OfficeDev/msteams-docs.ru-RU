...
Ваш робот также должен иметь возможность отвечать на такие вещи, как "*Привет*", "*Справка*" и "*спасибо*", при этом учитывается типичные опечатки и коллокуиалисмс. Пример:
