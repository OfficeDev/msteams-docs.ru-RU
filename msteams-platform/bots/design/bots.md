...
В следующем примере бот отвечает на каждое сообщение с вариантами действий, которые могут потребоваться сделать далее:
...
Вкладка упрощает работу с ботом. Например, если бот может создавать рабочие элементы, было бы неплохо показать все эти элементы в центре расположения на вкладке. Дополнительные сведения см. [в проекте вкладок](../../tabs/design/tabs.md).
