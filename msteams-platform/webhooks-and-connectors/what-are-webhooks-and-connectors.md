...
| Средства сборки | • [Обзор набора средств Teams для Visual Studio Code](../toolkit/teams-toolkit-fundamentals.md) <br> • [Обзор набора средств Teams для Visual Studio](../toolkit/teams-toolkit-overview-visual-studio.md) <br> • [Библиотека TeamsFx](../toolkit/TeamsFx-CLI.md) <br> • [Пакет SDK для TeamsFx](../toolkit/TeamsFx-SDK.md) | Инструменты не требуются |
| Требуется облачный ресурс | Azure Bot Framework | Ресурсы не требуются |
| Учебник | [Создание бота уведомлений с помощью JavaScript](../sbs-gs-notificationbot.yml) | Н/Д |
