...
author: clearab
description: Узнайте, как веб-перехватчики и соединители помогают подключать веб-службы к каналам и командам в Microsoft Teams. Сведения о входящих, исходящих веб-перехватчиках и Office 365 соединителях.
...
Mer informasjon о различиях между ботом уведомлений и входящим веб-перехватчиком, чтобы можно было выбрать правильные решения для сценариев:
...
| Триггер поддерживается | Поддерживаются все триггеры. Если вы используете Набор средств Teams, вы можете быстро получить проекты шаблонов со следующими триггерами: <br> • Триггер времени, размещенный в функциях Azure. <br> • Повторное изменение триггера HTTP, размещенного в службе приложений Azure <br> • Триггер HTTP, размещенный на Azure Functions | Все поддерживаемые триггеры |
