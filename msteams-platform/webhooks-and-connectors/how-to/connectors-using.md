...
Это сообщение производит следующую карту в канале:
...
Следуйте этим шагам, чтобы увидеть, как отправить простую карту в разъем:
...
Следующая manifest.jsсодержит основные элементы, необходимые для тестирования и отправки приложения:
...
1. [Настройка пользовательских webhook](#setting-up-a-custom-incoming-webhook) в Teams.</br></br>
1. Создайте адаптивный файл JSON:
...
1. Проверьте адаптивную карту с почтальоном.
...
Чтобы тестировать соединитель, отправьте его команде, как в любом другом приложении. Вы можете создать пакет .zip с помощью файла манифеста из панели разработчиков Connectors, который был изменен в соответствии с предыдущим разделом и двумя файлами значков.

После отправки приложения откройте список соединителей с любого канала. Прокрутите вниз, чтобы увидеть приложение в **разделе Загружено:**
...
[Office 365 Коннекторы — Microsoft Teams](/connectors/teams/)