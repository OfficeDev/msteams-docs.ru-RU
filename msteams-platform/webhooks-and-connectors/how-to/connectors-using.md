...
author: laujan
description: Создание интерактивных сообщений, отправка сообщений через входящий веб-перехватчик, Office 365 соединитель, cURL или PowerShell. Отправка адаптивных карточек. Транзакция на основе времени.
ms.topic: how-to
