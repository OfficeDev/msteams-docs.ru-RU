...
Это ограничение распространяется на трафик, который соединителю или входящий веб-перехватчику разрешено создавать на канале. Количество запросов веб-перехватчиков или соединителей будет ограничено при превышении ограничения скорости. Время, в течение которого применяется регулирование, напрямую связано с параметрами превышения частоты запросов. Например, если соединитель или веб-перехватчик направляет более 100 запросов сообщений за 3600 секунд, в течение следующих 3600 секунд он будет регулироваться следующим образом:

| Период времени (с)  | Максимально допустимое число запросов сообщений  |
|---|---|
| 1   | 4  |  
| 30   | 60  |  
| 3600 (1 час)  | 100  | 
