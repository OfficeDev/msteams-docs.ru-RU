...
> [!NOTE]
> Поток выполняется полностью в пределах Teams в качестве размещенного интерфейса.
