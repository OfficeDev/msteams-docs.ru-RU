...
| [Azure Active Directory](../tabs/how-to/authentication/auth-tab-aad.md) | Облачная служба управления идентификацией и доступом Майкрософт. Она помогает прошедшим проверку подлинности пользователям получать доступ к внутренним и внешним ресурсам. |
...
| [Секрет клиента](../bots/how-to/authentication/add-authentication.md) | Секретная строка, которую приложение использует для подтверждения своей личности при запросе маркера. Кроме того, его можно называть паролем приложения.|
...
|[Министерство обороны (DoD)](../concepts/app-fundamentals-overview.md#government-community-cloud)| Среды DoD обеспечивают соответствие требованиям к безопасности министерства обороны, дополнением к Федеральным регламентам по приобретению (DFARS) и международным правилами по трафику в окружных правилах (ITAR).|
...
| Термин | Определение |
| --- | --- |
| [Учетная запись разработчика E5](../toolkit/tools-prerequisites.md) | Подписка разработчика E5 для создания приложений с целью расширения Microsoft 365. Она включает 25 лицензий пользователей, в том числе администратора, только для целей разработки.  <br>**См. также**: [учетная запись Microsoft 365](#m) |
...
| Термин | Определение |
| --- | --- |
|[Облако сообщества для государственных организаций (GCC)](../concepts/app-fundamentals-overview.md#government-community-cloud)| Среда GCC обеспечивает соответствие федеральным требованиям к облачным службам, включая FedRAMP High, Defense Federal Acquisition Regulations Supplement (DFARS), а также требования для судебной и федеральной налоговых информационных систем (типы данных CJI и FTI).|
|[Облако сообщества для государственных организаций (GCC) High](../concepts/app-fundamentals-overview.md#government-community-cloud)|Высокоуровневые среды GCC обеспечивают соответствие требованиям безопасности Министерства обороны Сша (DoD), дополнительным положениям о приобретении (DFARS) и Международным регламентам по поставкам и защите от потери данных (ITAR).<br>**См. также**: [Department of Defense (DoD)](#d)|
