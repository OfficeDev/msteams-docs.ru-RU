...
| [App Studio](../concepts/build-and-test/app-studio-overview.md) | Приложение для создания или интеграции ваших собственных приложений Microsoft Teams. Теперь оно превратилось в портал разработчика. <br> > Если вы использовали App Studio, рекомендуем попробовать "Портал разработчика", чтобы настраивать и распространять приложения Teams, а также управлять ими. Решение App Studio будет упразднено к 1 августа 2022 г. <br> **См. также**: [портал разработчика](#d) |
