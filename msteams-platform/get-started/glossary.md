...
| [Teams](../overview.md) | Microsoft Teams — универсальное приложение для обмена сообщениями в вашей организации. Это рабочее пространство для собраний, совместной работы и общения в реальном времени, обмена файлами и приложениями. |
