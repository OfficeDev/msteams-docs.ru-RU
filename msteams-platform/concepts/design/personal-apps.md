...
|D|**Дополнительные меню:** включает дополнительные сведения о приложении и параметры. (Можно также сделать **Параметры** вкладку.)|
...
Используйте один из следующих Teams пользовательского интерфейса для разработки личной вкладки:
