...
description: Узнайте, как разработать личное приложение Teams и получить комплект разработчика для пользовательского интерфейса Microsoft Teams, создать такие компоненты, как информационная панель, форма, доска задач для мобильных и настольных компьютеров. Ознакомьтесь с рекомендациями по разработке личных приложений.
author: heath-hamilton
ms.topic: conceptual
ms.localizationpriority: high
ms.author: lajanuar
keywords: комплект разработчика для пользовательского интерфейса личное приложение веб-просмотр навигационный бот вкладка iframe информационная панель форма шаблон
ms.openlocfilehash: 51087d0f055130e822d837d9e78eda5b1b28966a
ms.sourcegitcommit: f15bd0e90eafb00e00cf11183b129038de8354af
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/28/2022
ms.locfileid: "65111817"
---
# <a name="designing-your-personal-app-for-microsoft-teams"></a>Проектирование личных приложений для Microsoft Teams

Личное приложение может быть ботом, закрытой рабочей областью или и тем, и другим.  Иногда оно работает как место для создания или просмотра контента, в других случаях оно предлагает пользователю обзор всего, что принадлежит ему, когда приложение настроено как вкладка в нескольких каналах.
...
(Примечание по реализации. Частная рабочая область основана на возможностях [*личной вкладки*](../../build-your-first-app/build-personal-tab.md).)
