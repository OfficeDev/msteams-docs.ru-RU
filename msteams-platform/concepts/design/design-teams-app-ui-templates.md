...
description: Узнайте, как быстрее проектировать приложение с помощью стандартизированных компонентов пользовательского интерфейса, макетов и шаблонов, которые часто Microsoft Teams.
ms.author: lajanuar
...
Быстрее Microsoft Teams приложения с помощью шаблонов пользовательского интерфейса. Шаблоны — это коллекция компонентов Fluent пользовательского интерфейса, которые работают в распространенных Teams вариантов использования, что дает вам больше времени для определения наилучшего интерфейса для пользователей.
...
Получите шаблоны пользовательского интерфейса для разработки приложения из Microsoft Teams пользовательского интерфейса, который также содержит подробную информацию об использовании, структуре, специальных возможностях и рекомендациях.
...
Установите пример приложения, чтобы увидеть, как шаблоны пользовательского интерфейса выглядят и работают в Teams контекстах.
...
В Teams календаре пользователь просматривает, планирует и управляет предстоящими и прошлыми событиями для себя или группы.
...
Панель мониторинга отображает различные типы содержимого в центральном расположении (например, Teams личные приложения или вкладки). Пользователи должны иметь возможность настраивать по крайней мере некоторые из элементов, которые они видят на панели мониторинга.
...
Вы можете разработать потоки входа в приложение для разных Teams и поставщиков удостоверений. В следующем примере приведен единый вход (SSO), который мы рекомендуем использовать для простейшей проверки подлинности.
...
Параметры экранах пользователи могут настраивать параметры приложения. (Примечание. Параметры является контейнером для [базовых компонентов пользовательского интерфейса](~/concepts/design/design-teams-app-basic-ui-components.md).)
...
* [Разработка приложения с помощью базовых Fluent пользовательского интерфейса](~/concepts/design/design-teams-app-basic-ui-components.md)
