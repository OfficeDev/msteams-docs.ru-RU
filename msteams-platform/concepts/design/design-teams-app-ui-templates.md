...
Быстрее Microsoft Teams приложение с помощью шаблонов пользовательского интерфейса. Шаблоны — это коллекция компонентов Fluent на основе пользовательского интерфейса, которые работают в общих Teams случаях использования, что дает вам больше времени для работы с пользователями.
...
Захватите шаблоны пользовательского интерфейса для разработки приложения из Microsoft Teams пользовательского интерфейса, который также включает в себя обширные сведения об использовании, анатомии, доступности и практических методиках.
...
:::image type="content" source="../../assets/form.png" alt-text="В примере показан шаблон пользовательского интерфейса форм на рабочем столе." border="false":::
