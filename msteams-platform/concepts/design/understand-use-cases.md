...
description: Узнайте о возможностях приложений Microsoft Teams, таких как вкладки, боты, расширения собраний, расширения сообщений, соединители веб-перехватчиков, личные возможности приложений и общий интерфейс приложения.
ms.topic: conceptual
...
* **Изучение пользователей**:
  ...
  * Рекомендуется ознакомиться с модулем Lean [, как опубликовать приложение в магазине приложений Teams](/training/modules/microsoft-teams-publish-app-to-store/) , чтобы помочь с приложением пройти процесс отправки в Microsoft Teams store.
...
[Microsoft API Graph для Teams](/graph/teams-concept-overview) предоставляет доступ к сведениям о командах, каналах, пользователях и сообщениях, которые помогают создавать или улучшать функции вашего приложения.
