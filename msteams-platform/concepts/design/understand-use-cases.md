...
description: 'Узнайте о cabilities приложения Microsoft Teaams: вкладки, боты, расширения собраний, расширения сообщений, соединители веб-перехватчиков, взаимодействие с личным приложением, взаимодействие с общим приложением.'
ms.topic: conceptual
