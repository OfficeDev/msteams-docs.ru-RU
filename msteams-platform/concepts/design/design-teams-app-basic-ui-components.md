...
Вы можете проектировать и создавать приложение Teams с нуля, используя следующие основные компоненты пользовательского интерфейса Fluent. Разработанные как можно более плоские, эти компоненты могут работать в разных вариантах использования, темах и размерах экрана.
