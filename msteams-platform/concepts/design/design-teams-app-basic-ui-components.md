...
## <a name="group-list"></a>Групповой список
...
## <a name="key-value-pair"></a>Пара ключевых значений
...
## <a name="progress-indicator"></a>Индикатор прогресса
...
## <a name="status-label"></a>Метка status
