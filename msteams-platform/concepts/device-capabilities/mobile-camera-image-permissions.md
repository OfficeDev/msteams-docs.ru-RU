...
Чтобы интегрировать мультимедийные возможности, необходимо обновить файл манифеста приложения и вызвать API-интерфейсы мультимедийных возможностей.
...
Важно ознакомиться с [ошибками отклика API](#error-handling), чтобы обрабатывать ошибки в приложении Teams.

> [!NOTE]
>
> * Сейчас поддержка мультимедийных возможностей Microsoft Teams доступна только для мобильных клиентов.
...
> [!IMPORTANT]
>
> * API-интерфейсы `selectMedia`, `getMedia`, и `viewImages` можно вызывать из нескольких поверхностей Teams, таких как модули задач, вкладки и личные приложения. Подробнее см. в [Точки входа для приложений Teams. ](../extensibility-points.md).
