...
Если вы работаете с личным приложением, он ищет имя или идентификатор электронной почты в организации в Teams. Если приложение добавляется в чат или канал, контекст поиска настраивается в зависимости от сценария. Поиск ограничен участниками чата или канала.
