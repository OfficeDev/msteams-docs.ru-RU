...
1. Самостоятельная проверка приложения с помощью [средства проверки манифеста](https://docs.microsoft.com/microsoftteams/platform/concepts/deploy-and-publish/appsource/prepare/submission-checklist#teams-app-validation-tool) .
