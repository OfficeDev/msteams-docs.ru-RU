...
Этот значок используется для закрепленных расширений обмена сообщениями и когда приложение отображается в левой части Teams. Обратитесь к разделу [руководство по проектированию для значка "структура"](../../../../concepts/build-and-test/apps-package.md#outline-icon).
