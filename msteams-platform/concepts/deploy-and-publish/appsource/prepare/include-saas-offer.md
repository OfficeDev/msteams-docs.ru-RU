...
1.  [Опубликуйте приложение в Teams магазине](#publish-your-app).
...
* Ознакомьтесь с вариантом "Продажа через [*Microsoft*"](/azure/marketplace/plan-saas-offer#listing-options) для предложения SaaS, который необходим, если вы хотите, чтобы пользователи приобретли планы подписки на ваше приложение непосредственно в Teams магазине.
