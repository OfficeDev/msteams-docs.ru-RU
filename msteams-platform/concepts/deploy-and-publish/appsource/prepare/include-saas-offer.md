...
> [!IMPORTANT]
> Вы можете протестировать все этапы транзакции в Teams, пока ваше приложение не пройдет проверку в магазине. Дополнительные сведения см. в статье [Пробный предварительный просмотр монетизируемых приложений](Test-preview-for-monetized-apps.md).
