...
С помощью трансактабельного предложения Software-as-a-Service (SaaS) можно монетизировать приложение Teams, продавая планы подписки непосредственно из списка Teams магазина. Например, допустим, у вас есть бесплатное приложение, которое любой желающий может получить в магазине. Теперь вы можете предложить премиум и корпоративные планы для пользователей, которые хотят больше возможностей.
...
1. [Создание страницы для управления подпиской](#build-a-landing-page-for-subscription-management).
...
* Ознакомьтесь с вариантом "Продажа через [*Microsoft*"](/azure/marketplace/plan-saas-offer#listing-options) для предложения SaaS, которое требуется, если вы хотите, чтобы пользователи приобретали планы подписки для вашего приложения непосредственно в Teams магазине.
* Узнайте, Azure Active Directory один вход [(SSO)](/azure/marketplace/azure-ad-saas) помогает клиентам приобретать и управлять подписками. (Microsoft Azure Active Directory SSO (Azure AD) требуется для Teams приложений с предложениями SaaS.)
...
* Планирование мобильной связи. Чтобы не нарушать политики сторонних магазинов приложений, приложение не может включать ссылки, позволяющие пользователям приобретать планы подписки на мобильный телефон. Однако вы все равно можете указать, есть ли в вашем приложении функции, которые требуют подписки. Дополнительные сведения см. в соответствующих политиках [сертификации коммерческих рынков](/legal/marketplace/certification-policies#114048-mobile-experience).
...
* Когда пользователям назначена подписка, сообщите об этом через Teams бота или электронной почты. В сообщении включайте сведения о том, как добавить приложение в Teams и начать работу.
...
Когда кто-то закончит покупку плана подписки для вашего приложения в магазине Teams, коммерческий рынок направят его на вашу страницу, где он может управлять подпиской (например, назначить лицензию конкретному пользователю в своей организации).
...
Рассмотрим следующие подходы при создании посадочной страницы для Teams приложения, которое вы монетизируете. См. пример посадочной страницы в интерфейсе [покупки конечных пользователей](#end-user-purchasing-experience).
...
Перед публикацией предложения SaaS настоятельно рекомендуется проверить возможность приобретения. Это можно сделать, создав отдельное предложение только для тестирования. Дополнительные сведения см. [в обзоре](/azure/marketplace/plan-saas-offer#test-offer) тестового предложения, [создании тестового предложения](/azure/marketplace/create-saas-dev-test-offer) и [предварительном просмотре предложения](/azure/marketplace/test-publish-saas-offer).

> [!IMPORTANT]
> Вы можете протестировать end-to-end-транзакцию в Teams, пока приложение не завершит проверку магазина. Дополнительные сведения см. в [обзоре Test preview для монетизированных приложений](Test-preview-for-monetized-apps.md).

С точки Teams эти тесты должны убедиться, что количество лицензий и назначений совпадает с тем, что находится в центре администрирования Teams, когда пользователи:
...
Вы создали свое предложение SaaS и связали его с приложением Teams- пришло время опубликовать приложение в Teams магазине. Полные инструкции см[. в публикации приложения в Teams магазине](~/concepts/deploy-and-publish/appsource/publish.md).

> [!IMPORTANT]
> Даже если ваше приложение уже перечислены в Teams магазине, вам все равно необходимо снова пройти процедуру проверки магазина, чтобы включить ваше предложение SaaS.
...
1. В **диалоговом окте "Выбор плана подписки** " выберите нужный план и выберите **checkout**. (Примечание. Частные планы видны только пользователям в оргиях, на которые вы предоставляете предложение. Эти планы указаны значком **специального предложения**:::image type="icon" source="~/assets/icons/special-icon.png":::.)
