...
Средство проверки Microsoft Teams помогает устранить проблемы перед отправкой в Центр партнеров. Средство автоматически проверяет конфигурации вашего приложения на фоне тестовых случаев, используемых во время проверки магазина.
...
Предоставление инструкций и ресурсов, которые помогут рецензентам протестировать ваше приложение, в том числе:
* Тестовые учетные записи
* Учетные данные
* Ключи лицензии

Вы можете добавить инструкции в Центре партнеров или загрузить их в общедоступные расположения в SharePoint.
...
Предостередить тестовые учетные записи, если вашему приложению требуется лицензия или дополнительный безопасный список. Все учетные записи, которые вы предоставляете, должны включать предварительно заполненные данные, чтобы помочь в тестировании.

В зависимости от функций приложения может потребоваться предоставить все следующие учетные записи:

* Учетная запись администратора (требуется)
* Учетная запись без администрирования (требуется)
* Учетная запись, которая не предварительно настроена для правильной проверки первого запуска для регистрации (требуется)
...
Краткий сводка приложения, которая должна быть оригинальной, привлекательной и направленной для целевой аудитории. Сократить описание до одного предложения.
...
Длинное описание может предоставить повествование, которое подчеркивает ваши приложения':
...
Видео в вашем списке может быть наиболее эффективным способом сообщить, почему люди должны использовать ваше приложение. Ответы на следующие вопросы в видео:
...
Вы можете добавить URL-адрес для видео на YouTube или Vimeo.

#### <a name="best-practices-for-videos"></a>Лучшие практики для видео

* Сохраняйте видео в течение 60-90 секунд.
* Стремиться к качеству. В списке пользователи увидят ваше видео перед снимками экрана.
* Сообщить значение продукта в форме повествования.
