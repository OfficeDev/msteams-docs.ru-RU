...
### <a name="9989-personal-bots-must-send-a-welcome-message-on-first-launch"></a>&#9989; Personal Боты должен отправить приветственное сообщение при первом запуске
...
* Предоставить способ пересылки для использования ленты.
