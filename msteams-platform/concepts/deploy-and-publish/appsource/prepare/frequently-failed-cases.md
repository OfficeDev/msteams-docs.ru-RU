...
* Приложения не должны использовать Teams для основных пользовательских сценариев. Использование вкладок модулей задач для отображения сведений пользователю в Teams рекомендуется использовать вкладки AMD.
...
* Обязательно ознакомьтесь с инструкциями по четкому пересылке для нового пользователя о том, как подписаться на использование служб приложения. Если ссылка "готовая подписка" недоступна, можно выполнить простой способ переадресации на странице описания приложения, приветственное сообщение, справочное сообщение и окно входа, в котором пользователь может войти в службу. Приложения, у которых нет простой последовательности регистрации, могут также включать вкладку справки или ссылку на веб-страницу, где новый пользователь может просмотреть подробные инструкции по настройке приложения с помощью Microsoft Teams.  Это позволяет убедиться, что новый пользователь не отображается в роадблокк при первом запуске приложения.
...
* Вкладки, адаптивные карты, сообщения Bot и контент в модулях задач должны отвечать на экраны вариос мобильных устройств.
...
* Не должны быть включены какие-либо прямые ссылки на покупки в приложениях, демонстрационные предложения, Пользовательский интерфейс, предназначенный для приобретения платных версий, или ссылки на Интернет-магазины, где пользователи могут покупать или получать другие материалы, приложения или надстройки из приложения Teams в мобильную ОС (Android, iOS).
...
Ваше приложение Teams не должно учитывать конфиденциальные сведения, такие как инструмент "кредитная карта/финансовая оплата", личные сведения, сведения о работоспособности или трассировке контактов, которые не предназначены для просмотра этих данных.
...
### <a name="9989-clear-warning-before-downloading-any-files-or-exes-into-users-environment"></a>&#9989; очистить предупреждение перед загрузкой файлов или файлов exe в среду пользователя
Предупредите пользователей, прежде чем приложение загрузит файлы или exe на компьютер или в среду пользователя.
