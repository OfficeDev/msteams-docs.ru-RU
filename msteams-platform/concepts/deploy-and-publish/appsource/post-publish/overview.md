...
* Чтобы изменить приложение, перейдите в Центр партнеров, но не выбирайте **Добавить новое приложение**. Вместо этого перейдите на страницу приложения.
...
* Добавление или удаление расширения для обмена сообщениями.
* Добавление личной вкладки.
* Создание канала и вкладки группы.
* Добавление соединителя.
* Изменения конфигурации, связанные с регистрацией приложения Microsoft Azure Active Directory (Azure AD). Дополнительную информацию см. в статье [`webApplicationInfo`](~/resources/schema/manifest-schema.md#webapplicationinfo).
