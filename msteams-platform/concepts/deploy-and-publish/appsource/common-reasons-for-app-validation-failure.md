...
description: Узнайте о наиболее распространенных причинах сбоя проверки приложения, таких как неработающие ссылки, непредвиденные ошибки, сбои, нарушение допустимых правил домена, функциональные ошибки.
ms.topic: overview
author: v-ypalikila
...
* Отправка приложений, в которых разработчик изменил имя приложения, но старое имя приложения по-прежнему используется в приложении.
