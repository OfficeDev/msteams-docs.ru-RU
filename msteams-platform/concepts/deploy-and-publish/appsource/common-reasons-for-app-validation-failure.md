...
description: Ознакомьтесь с наиболее распространенными причинами сбоя проверки приложения, такими как неработающие ссылки, непредвиденные ошибки, сбои, нарушение правил домена, функциональные ошибки.
ms.topic: overview
author: v-ypalikila
