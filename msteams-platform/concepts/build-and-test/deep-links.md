...
Вы можете создать прямую ссылку на содержимое в Teams со своей вкладки. Это удобно, если вкладка должна быть связана с другим содержимым в Teams, например с каналом, сообщением, другой вкладкой, или должна использоваться для открытия диалогового окна планирования. Чтобы активировать ссылку с вкладки, сделайте вызов:

```Javascript
microsoftTeams.executeDeepLink(/*deepLink*/);
```

Этот вызов направляет к правильному URL-адресу или инициирует действие клиента, например открытие диалогового окна планирования либо установки приложения. Пример приведен в следующей статье:
...
Вы можете создавать прямые ссылки на личные чаты между пользователями, указав набор участников. Если чат с указанными участниками не существует, ссылка направляет пользователя в пустой новый чат. Новые чаты создаются в состоянии черновика, пока пользователь не отправит первое сообщение. Или же можно указать имя чата, если он еще не существует, вместе с текстом, который должен быть вставлен в поле создания сообщения пользователя. Эту функцию можно использовать в качестве ярлыка для пользователя, выполняющего ручное действие по навигации или созданию чата, а затем вводя сообщение.

Вариант использования: если вы возвращаете профиль пользователя Office 365 из бота в виде карточки, эта прямая ссылка позволит пользователю легко общаться с этим человеком.
...
Вы можете создавать прямые ссылки, чтобы делать только голосовые вызовы или голосовые и видеовызовы для одного пользователя или группы пользователей, указав тип вызова, как *аудио* или *аудио/видео* и участников. После вызова прямой ссылки и перед выполнением звонка клиент Teams запрашивает подтверждение для совершения звонка. В случае группового звонка можно позвонить группе пользователей VoIP и группе пользователей ТСОП в одном и том же вызове прямой ссылки.
