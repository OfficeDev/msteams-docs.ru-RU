...
В следующем видео показано, как встраить share в Teams кнопку:
<br>
...
1. Добавьте элемент HTML на свою веб-страницу с атрибутом класса `teams-share-button` и ссылкой для совместного использования в атрибуте `data-href`.
    ...
    После этого значок Teams добавляется на ваш веб-сайт. На следующем рисунке показан значок «Отправить в Teams»:
