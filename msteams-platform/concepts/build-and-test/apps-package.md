...
description: Узнайте, как упаковать приложение Microsoft Teams и отправить его в Teams. Создайте пакет приложения, включите пользовательскую отправку, убедитесь, что приложение запущено и доступно с помощью HTTP.
...
ms.locfileid: "68791456"
---
# <a name="create-teams-app-package"></a>Создание пакета приложения в Teams

Вам нужен пакет приложения, однако вы планируете распространять приложение Microsoft Teams. Допустимый пакет — это ZIP-файл, содержащий следующее:
