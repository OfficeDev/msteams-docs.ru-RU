...
1. Скачайте и сохраните плагины Moodle [OpenID Подключение](https://moodle.org/plugins/auth_oidc) и [Microsoft 365 интеграции](https://moodle.org/plugins/local_o365) на локальном компьютере.
    ...
    >
    > Кроме того, [Microsoft 365 Teams темы](https://moodle.org/plugins/theme_boost_o365teams) настоятельно рекомендуется.
...
1. На **Teams Параметры настроить** необходимые параметры, чтобы включить интеграцию Teams приложения.
    ...
    1. Чтобы включить **Подключение OpenID**, выберите ссылку **Управление** проверкой подлинности и выберите значок глаза в строке **OpenId Подключение**, если она затеняется.
...
1. **Скопируйте ID приложения** и вклеите его в поле **Bot Application ID** на странице **Параметры**.

1. Выберите **кнопку Создание нового пароля** . Скопируйте созданный пароль и вклейте его в поле **пароль** для ботов на странице **Параметры**.
...
> [!div class="checklist"]
> * Выберите **Развертывание в Azure** и заполняйте форму с помощью необходимых сведений, таких как код **приложения-бота**, пароль приложения-бота и секрет Moodle на Teams Параметры странице. Сведения Azure на странице **Настройка** . 
...
1. В Moodle откройте страницу **командной Параметры** вашей Microsoft 365 Плагины Moodle.
