...
1. После обновления страницы вы увидите другой новый раздел, Администратор **предоставить & дополнительные сведения**.
    1. Выберите **ссылку "Администратор согласия**", введите Microsoft 365 учетные данные глобального администратора, а затем  примите, чтобы предоставить разрешения.
...
1. На **Teams Параметры** настройте необходимые параметры, чтобы включить интеграцию Teams приложения.
    ...
    1. Чтобы включить веб-службы, включаемые функции API Moodle, выберите ссылку "Дополнительные функции", а затем установите флажок рядом с пунктом "Включить веб-службы".
...
1. Щелкните значок "Приложения" в нижней левой области.
...
Когда курс Moodle синхронизируется, Teams автоматически устанавливает приложение Moodle в команде, создает вкладку Moodle в канале "Общие" Teams и настраивает его для хранения страницы курса для курса Moodle, из которого оно синхронизируется. Теперь вы можете начать работу с курсами Moodle непосредственно из Teams.
