...
## <a name="cookies-in-brief"></a>Cookies in brief
 ...
 |**Второе стороне cookie**|Второпартийное cookie—это технически то же самое, что и первопартийное cookie. Разница заключается в том, что данные делятся со второй стороной через соглашение о партнерстве с данными (например, Microsoft Teams [аналитики и отчетности).](/microsoftteams/teams-analytics-and-reports/teams-reporting-reference) |
