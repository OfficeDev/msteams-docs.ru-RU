...
|Имя| Тип| Максимальный размер | Обязательный | Описание|
|---|---|---|---|---|
|`id`|Строка|36 символов|✔|Идентификатор приложения в Microsoft Azure Active Directory (Azure AD). Этот идентификатор должен быть глобальным уникальным идентификатором.|
