...
Версия схемы манифеста, используемая этим манифестом. Используйте `m365DevPreview` только при предварительном просмотре [приложений Teams, работающих в Office и Outlook](../../m365-apps/overview.md). В противном случае, используйте `devPreview` для всех других функций предварительного просмотра Teams.
