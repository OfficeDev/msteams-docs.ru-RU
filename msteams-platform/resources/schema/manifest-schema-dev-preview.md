...
> [!NOTE]
> Дополнительные сведения о программе и о том, как можно присоединиться, см. в [Developer Preview.](~/resources/dev-preview/developer-preview-intro.md)
> Если вы не используете предварительный просмотр разработчика, не следует использовать эту версию манифеста. См. [справку.](~/resources/schema/manifest-schema.md) Схема манифеста Microsoft Teams для публичной версии манифеста.
