...
Боты, добавленный в команду, становится другим участником группы и может быть @mentioned в составе беседы. На самом деле Боты получают сообщения только при @mentioned, поэтому другие беседы по каналу не отправляются в Bot.

В группе или канале Bot должна предоставляться информация, соответствующая всем участникам. В то время как ваш Bot может предоставить любую информацию, относящуюся к опыту, следует учитывать, что беседы видны всем пользователям. Таким образом, для беседы с одним и тем же участником группы или канала должны быть добавлены все пользователи.

Ваш робот, как и то, может быть полностью связан со всеми областями без необходимости дополнительной работы. В Microsoft Teams не предполагается, что функция Bot во всех областях, но вы должны убедиться, что у ленты есть пользовательское значение в любой области, которую вы выбрали для поддержки. Для получения дополнительных сведений об областях обратитесь к разделу [приложения в Microsoft Teams](~/concepts/build-and-test/app-studio-overview.md).

Разработка ленты, работающей в группах или каналах, использует те же функции, что и личные беседы. Дополнительные события и данные в полезных данных содержат сведения о группах и каналах Teams. Эти отличия, а также ключевые отличия в общих функциональных возможностях описаны в следующих разделах.
