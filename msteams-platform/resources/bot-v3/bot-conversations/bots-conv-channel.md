...
Ваш бот, как и он есть, может быть полностью актуальным во всех областях, не требуя дополнительной работы. В Microsoft Teams не ожидается, что бот будет работать во всех областях, но следует убедиться, что бот предоставляет значение пользователя в любой области, которую вы выбрали для поддержки. Подробнее об областях см. в разделе [Приложения в Microsoft Teams](~/concepts/build-and-test/app-studio-overview.md).
