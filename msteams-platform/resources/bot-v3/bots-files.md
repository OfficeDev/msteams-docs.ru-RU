...
Определение будет выглядеть следующим образом: `"supportsFiles": true`. Если бот не включается `supportsFiles`, следующие функции не будут работать.
...
4. При необходимости можно удалить исходную карточку согласия, если вы не хотите, чтобы пользователь принял дальнейшие отправки того же файла.
