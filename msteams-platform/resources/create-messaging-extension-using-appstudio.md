...
Вы можете использовать приложение App Studio из Microsoft Teams клиента, чтобы помочь создать манифест приложения.
...
На вкладке **Finish =>** и распространения можно скачать пакет приложения (который включает манифест приложения, а также значки приложения) или установить пакет.
...
1. **Location**. Расширение обмена сообщениями можно вызвать из области составить сообщение, командное поле или @mentioned в чате собрания.
...
* [Понимание Teams возможностей приложений](../concepts/capabilities-overview.md)
