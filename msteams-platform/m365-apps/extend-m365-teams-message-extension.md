...
:::image type="content" source="images/outlook-web-compose-more-apps.png" alt-text="Нажмите кнопку &quot;Больше приложений&quot; в нижней части окна outlook.com, чтобы начать использовать расширение сообщения.":::
