...
1. Откройте **меню вылетов** приложений в нижней части окна композиции.

:::image type="content" source="images/outlook-web-compose-more-apps.png" alt-text="Щелкните меню &quot;Больше приложений&quot; в нижней части окна состава почты, чтобы использовать расширение сообщения":::
