...
:::image type="content" source="images/azure-app-registration-clients.png" alt-text="Авторизуй клиентские ИД из лезвия *Регистрация приложений* на портал Azure":::
...
При обновлении личной вкладки Teams и ее загрузке в Teams она выполняется в Outlook Windows, в Интернете, Office в Windows и в Интернете (office.com). Вот как просмотреть его из этих Microsoft 365 опытом.
