...
description: Из этой статьи вы узнаете, как расширить приложение личной вкладки Teams в Microsoft 365, обновив личную вкладку для запуска в Outlook и Office.
ms.date: 05/24/2022
ms.topic: tutorial
ms.custom: m365apps
