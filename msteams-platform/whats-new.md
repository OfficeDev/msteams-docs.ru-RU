...
| --- | --- | --- |
|12/20/2021 | Введено руководство для приложения, связанного с предложением SaaS. | Раздайте > app Publish в Teams магазина > проверки > руководства по приложениям, связанным с [предложением SaaS](concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md#apps-linked-to-saas-offer)|
