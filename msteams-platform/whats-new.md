...
| -------- | --------- | ----------------|
|11/13/2021|Ботам можно включить получение всех сообщений канала с помощью согласия на использование ресурсов (RSC).|[Получение всех сообщений с помощью RSC,](~/bots/how-to/conversations/channel-messages-with-rsc.md)обзор [бесед](~/bots/how-to/conversations/conversation-basics.md)ботов и [разговоров о каналах и группах](~/bots/how-to/conversations/channel-and-group-conversations.md)|
|10/28/2021 | Монетизация Teams приложения с помощью трансактируемых SaaS-предложений.| [Включите предложение SaaS в Teams приложение](~/concepts/deploy-and-publish/appsource/prepare/include-saas-offer.md)|
|10/25/2021| Обновленный модуль Get started для Microsoft Teams документации разработчика с новой структурой и процедурами в пошаговом руководстве.| [Начало работы с первым приложением Teams приложения](get-started/get-started-overview.md)|
|10/21/2021| Добавьте `registerOnFocused` API для вкладок или личных приложений. |[Добавление `registerOnFocused` API для вкладок или личных приложений](tabs/how-to/create-personal-tab.md#add-registeronfocused-api-for-tabs-or-personal-apps)|
|10/20/2021| Этап собрания теперь доступен в ga.|[Включить и настроить приложения для Teams собраний](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md)|
...
|10/05/2021| Скрыть Teams приложение до тех пор, пока администратор не разрешит открыть приложение.| [Скрыть Teams, пока администратор не утвердит](concepts/design/enable-app-customization.md#hide-teams-app-until-admin-approves)|
...
|09/21/2021|Teams поддерживает AAD объекта и upN в упоминаниях пользователей для ботов и входящих веб-ок.|[AAD объект iD и UPN в упоминаниях](task-modules-and-cards/cards/cards-format.md#format-cards-with-markdown)пользователей , [Карты- Обзор](task-modules-and-cards/what-are-cards.md#support-for-aad-object-id-and-upn-in-user-mention)|
...
|08/25/2021| Введено пошаговая руководство по созданию Teams бота с одним входом (SSO).| [Пошаговое руководство по созданию Teams с SSO](sbs-bots-with-sso.yml)|
|08/19/2021| Событие обновления установки, полученное при установке бота в поток беседы.| [Событие обновления установки](bots/how-to/conversations/subscribe-to-conversation-events.md#installation-update-event)|
|08/12/2021|Создание вкладок с помощью адаптивных карт.|[Создание вкладок с использованием адаптивных карточек](tabs/how-to/build-adaptive-card-tabs.md)|
|08/04/2021|У вкладок больше не будет поля, связанные с их опытом.| [Удаление полей вкладок](resources/removing-tab-margins.md)|
|07/08/2021|Teams добавляет поддержку приложений на собраниях. |[Расширяемость приложения для собраний](apps-in-teams-meetings/meeting-app-extensibility.md)|
...
|05/24/2021| Обновленные Teams приложения с мобильными шаблонами.|[Проектирование Teams приложения](~/concepts/design/design-teams-app-overview.md)|
|05/13/2021| Добавлены сведения о mConnect и Skooler.|[Система управления обучением Moodle](resources/moodle-overview.md)|
|05/10/2021| Выпущен манифест приложения v1.10.|[Схема манифеста](resources/schema/manifest-schema.md) |
...
|04/29/2021 | Поддержка универсальных действий для адаптивных карт v1.4. | [Универсальные действия для адаптивных карточек](task-modules-and-cards/cards/universal-actions-for-adaptive-cards/overview.md) |
