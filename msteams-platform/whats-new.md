...
***11 октября 2022*** г. Создайте прямую ссылку для совместного использования содержимого [на собраниях.](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md#generate-a-deep-link-to-share-content-to-stage-in-meetings)
...
| **Date** | **Обновление** | **Найти здесь** |
| -------- | --------- | ------------------ |
| 09/23/2022 | Добавлена поддержка приложения для собраний по расписанию. | Создание приложений для собраний и звонков Teams > [приложениях для унифицированных собраний](apps-in-teams-meetings/meeting-app-extensibility.md) |
...
Недоступные функции платформы Microsoft Teams.
