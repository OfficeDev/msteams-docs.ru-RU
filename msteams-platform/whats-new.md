...
| 23.02.2022 |Microsoft Teams хранит параметры ранжирования| Распространение приложения > Публикация в магазине Teams > [Параметры рейтинга магазина Microsoft Teams](concepts/deploy-and-publish/appsource/post-publish/teams-store-ranking-parameters.md)|
