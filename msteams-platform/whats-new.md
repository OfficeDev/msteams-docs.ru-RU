...
|05/25/2021| Новый портал разработчиков для Teams для управления вашими Teams приложениями. | [Портал разработчика для Teams](concepts/build-and-test/teams-developer-portal.md) |
