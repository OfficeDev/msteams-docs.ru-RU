...
| --- | --- | --- |
|11/29/2021|Интерактивный режим для обмена этапом собраний.|[Общий этап собраний,](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md#shared-meeting-stage) [ссылки на API приложений](apps-in-teams-meetings/API-references.md)для собраний и схема [манифеста предварительного просмотра разработчика](resources/schema/manifest-schema-dev-preview.md)|
