...
Функции платформы Teams, доступные всем разработчикам приложений.

**Ноябрь 2022 г.**

***2 ноября 2022 г.:*** [поддержка глобальной маршрутизации для API ботов](bots/how-to/conversations/send-proactive-messages.md#create-the-conversation).
...
| -------- | --------- | ----------------|
| 10/27/2022 | Знакомство с ботом рабочего процесса для Teams. | Средства и пакеты SDK > Набор средств Teams > Использование набора средств Teams для создания приложения > Разработка приложения Teams > Создание приложения с несколькими возможностями > [создание бота рабочего процесса Teams](sbs-gs-workflow-bot.yml) |
| 10/26/2022 | Создайте приложение на собрании, позволяющее участникам собрания подписывать документы в режиме реального времени. | Создание приложений для собраний и звонков Teams > Включение и настройка приложений для собраний Teams > [этап создания приложений для собраний Teams](apps-in-teams-meetings/build-apps-for-teams-meeting-stage.md#build-an-in-meeting-document-signing-app) |
| 10/19/2022| Портал разработчика для Teams теперь доступен для клиентов GCC. | Средства и пакеты SDK > портал разработчика для Teams > [Обзор](concepts/build-and-test/teams-developer-portal.md)|
| 10/13/2022| Настройте NavBar и создайте меню переполнения для нескольких действий. | Проектирование возможностей приложения > приложений > [личные приложения](concepts/design/personal-apps.md#configure-and-add-multiple-actions-in-navbar)|
| 10/13/2022| Настройка кнопки "Назад" приложения. | Проектирование возможностей приложения > приложений > [личные приложения](concepts/design/personal-apps.md#configure-back-button)|
| 10/12/2022| Приложения поддерживаются в мгновенных собраниях, 1-на-1 и групповых звонках. | Создание приложений для звонков и собраний Teams > [Обзор](apps-in-teams-meetings/teams-apps-in-meetings.md)|
| 10/12/2022| Холст Live Share | Создание приложений для собраний и звонков Teams > расширенной совместной работы с помощью Live Share > [Canvas](apps-in-teams-meetings/teams-live-share-canvas.md)|
...
| 18.02.2022 | Обновлен модуль обзора для сопоставления приложения Teams с целями организации, а также историями пользователей и для изучения функций приложения Teams | Обзор [> приложения Teams, которое подходит](overview.md) |
| 18.02.2022 | Модуль "Основные сведения о приложении" теперь называется "Планирование приложения" и включает сопоставление случаев использования с функциями Teams и контрольный список для планирования приложений | [Общие сведения](~/concepts/app-fundamentals-overview.md) о планировании > приложения |
...
| 11.02.2022 | Общая трибуна собраний| • Создание приложений для собраний Teams > [Общая сцена собрания](apps-in-teams-meetings/build-tabs-for-meeting.md) </br> • Создание приложений для собраний Teams > [создание приложений для собраний Teams](apps-in-teams-meetings/build-apps-for-teams-meeting-stage.md) </br> • Манифест приложения > Общедоступная предварительная версия для разработчиков > [Схема манифеста в предварительной версии для разработчиков](resources/schema/manifest-schema-dev-preview.md)|
...
| 25.01.2022 | API отправки субтитров в режиме реального времени | Создание приложений для собраний Teams > API приложений для собраний> [API расширенных собраний](apps-in-teams-meetings/meeting-apps-apis.md)|
...
|20.10.2021| Сцена собрания теперь поддерживается в общедоступной версии | Разработка приложений для собраний Teams > [Включение и настройка приложений для собраний Teams](apps-in-teams-meetings/build-tabs-for-meeting.md) |
...
|08.07.2021|В мобильную версию Teams добавлена поддержка приложений на собраниях | Создание приложений для собраний Teams > [создание приложений для собраний Teams](apps-in-teams-meetings/build-apps-for-teams-meeting-stage.md) |
...
Недоступные функции платформы Teams.
