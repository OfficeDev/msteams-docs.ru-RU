...
| --- | --- | --- |
| 11/30/2021 | Обновлено Создание первого приложения с помощью SPFx пошагового руководства для Teams набор средств обновлений 3.0.0. | Начало работы > [создание первого приложения с помощью SPFx](sbs-gs-spfx.yml) |
...
| 11/29/2021 |Интерактивный режим для обмена этапом собраний.|• Создание приложений для Teams собраний > [общего этапа собраний](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md#shared-meeting-stage) </br> • Создание приложений для Teams собраний > ссылок на [API приложений для собраний](apps-in-teams-meetings/API-references.md) </br> • Схема манифеста > разработчика > [предварительного просмотра манифеста разработчика](resources/schema/manifest-schema-dev-preview.md)|
...
| 11/17/2021 | Обновленные Microsoft Teams проверки хранения| Распространение руководства по проверке > приложения в Teams магазине > [Store](~/concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md)|
