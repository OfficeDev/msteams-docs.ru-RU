...
| -------- | --------- | ------------------ |
|5/24/2021|Обновленные Teams руководства по разработке приложений с мобильными шаблонами и другими.|[Проектирование Teams приложения](~/concepts/design/design-teams-app-overview.md)
