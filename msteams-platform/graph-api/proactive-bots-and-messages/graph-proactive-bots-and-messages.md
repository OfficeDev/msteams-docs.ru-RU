...
description: Упреждающее установку приложения с помощью API Graph. Проверьте, установлен ли бот, и получите идентификатор чата беседы, чтобы отправить упреждающее сообщение.
...
* [Ограничения службы Microsoft Teams](/graph/throttling-limits#microsoft-teams-service-limits)
