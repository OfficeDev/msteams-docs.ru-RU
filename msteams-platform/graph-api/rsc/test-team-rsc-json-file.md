...
ms.locfileid: "53069066"
---
# <a name="test-team-rsc-postman-collection-json"></a><span data-ttu-id="2d52a-104">Тестовая группа RSC Postman коллекция JSON</span><span class="sxs-lookup"><span data-stu-id="2d52a-104">Test team RSC Postman collection JSON</span></span>
