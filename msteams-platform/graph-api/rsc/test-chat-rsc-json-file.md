---
title: Протестировать согласие на общение в Teams
description: Проверка согласия на использование ресурсов для чата в Teams postman
...
ms.locfileid: "52994411"
---
# <a name="test-chat-rsc-postman-collection-for-json"></a><span data-ttu-id="c85d3-104">Test chat RSC Postman collection for JSON</span><span class="sxs-lookup"><span data-stu-id="c85d3-104">Test chat RSC Postman collection for JSON</span></span>
