...
---
# <a name="create-your-first-microsoft-teams-app-using-nodejs"></a>Создайте первое Microsoft Teams с помощью Node.js

В этом руководстве вы можете начать создавать приложение Microsoft Teams с помощью Node.js.
...
Помните, что обратите внимание на URL-адрес приложения, так как это потребуется позже при регистрации приложения в Teams с помощью студии App. Блокнот отлично работает для этой цели.
...
Выберите один из случайных текстов, и в нижней части вы увидите карту, отформатированную и готовую к отправке с собственным сообщением:
