...
Универсальные действия для адаптивных карточек — это общая серверная часть бота для обработки действий и новый тип действия, `Action.Execute`который работает в разных приложениях, таких как Teams и Outlook.
