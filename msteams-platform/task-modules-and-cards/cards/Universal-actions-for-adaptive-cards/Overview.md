...
---
# <a name="universal-actions-for-adaptive-cards"></a>Универсальные действия для адаптивных карт
...
* [Пользовательские представления](#user-specific-views)
