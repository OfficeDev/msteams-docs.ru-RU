...
description: Узнайте, как работать с универсальными действиями для адаптивных карточек, включая схему для UniversalActions для адаптивных карточек, модель обновления и обратную совместимость, с помощью примеров кода.
ms.topic: conceptual
