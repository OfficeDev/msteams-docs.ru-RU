...
Динамические значения можно передать в адаптивной карточке с помощью символа доллара ($) и фигурных скобок. Дополнительные сведения см. в разделе [Шаблоны адаптивных карточек](/adaptive-cards/templating/).
