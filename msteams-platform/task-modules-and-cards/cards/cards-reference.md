...
| Карточка соединителя Office 365 | ✔️ | ❌ | ✔️ | ❌ | ✔️ | ✔️ | ✔️ |
...
Изображения должны иметь разрешение не более 1024x1024 и иметь формат PNG, JPEG или GIF. GIF с анимацией не поддерживается.
...
> [!NOTE]
> Если карточка содержит URL-адрес изображения, который перенаправляется перед окончательным изображением, перенаправление в URL-адресе изображения не поддерживается. Это относится к изображениям, размещенным для общего доступа в общедоступном облаке.
...
> * Платформа Teams поддерживает функции адаптивных карточек версии 1.3 или более ранних версий для других возможностей, таких как карточки, отправленные пользователем (расширения сообщений на основе поиска и развертывание ссылок), вкладки и модули задач.
...
> * Протестируйте адаптивную карточку полной ширины в узких форм-факторах, таких как мобильные панели и панели на стороне собрания, чтобы убедиться, что содержимое не усечено.

### <a name="example-of-adaptive-card"></a>Пример адаптивной карточки

:::image type="content" source="~/assets/images/cards/adaptivecard.png" alt-text="Пример адаптивной карточки":::
...
В адаптивной карточке можно передавать динамические значения, используя символ доллара ($) и фигурные скобки. Подробнее см. в разделе [Шаблоны адаптивных карточек](/adaptive-cards/templating/).
...
:::image type="content" source="../../assets/images/Cards/hero.png" alt-text="Карточка главного имиджевого баннера":::
...
:::image type="content" source="../../assets/images/Cards/receipt.png" alt-text="карточка квитанции":::
...
:::image type="content" source="../../assets/images/Cards/thumbnail.png" alt-text="карточка эскиза":::
...
:::image type="content" source="../../assets/images/Cards/carousel.png" alt-text="Коллекция с каруселью":::
...
:::image type="content" source="../../assets/images/Cards/list.png" alt-text="коллекция списков":::
