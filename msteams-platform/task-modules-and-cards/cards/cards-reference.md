...
Прежде чем определить различные типы карт, поймите, как создать карточку героя, карту эскиза или адаптивную карту.
...
| [Office 365 Карта Connector](#office-365-connector-card) | Эта карта имеет гибкий макет с несколькими разделами, полями, изображениями и действиями. |
...
| Тип карты | Боты | Предварительные просмотры расширения сообщений | Результаты расширения сообщений | Модули задач | Исходяние веб-ок | Входящие веб-окки | Соединители O365 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Адаптивная карта | ✔ | ✖ | ✔ | ✔ | ✔ | ✔ | ✖ |
| Карта соединители O365 | ✔ | ✖ | ✔ | ✖ | ✔ | ✔ | ✔ |
| Карта hero | ✔ | ✔ | ✔ | ✖ | ✔ | ✔ | ✖ |
| Карта эскиза | ✔ | ✔ | ✔ | ✖ | ✔ | ✔ | ✖ |
| Карта списка | ✔ | ✖ | ✖ | ✖ | ✔ | ✔ | ✖ |
| Карта получения | ✔ | ✖ | ✖ | ✖ | ✖ | ✔ | ✖ |
...
Адаптивная карта — это настраиваемая карточка, которая может содержать любое сочетание текстов, речи, изображений, кнопок и полей ввода. Дополнительные сведения см. в [рублях Адаптивные карты v1.2.0](https://github.com/microsoft/AdaptiveCards/releases/tag/v1.2.0).
...
| элементы | Массив элементов списка | Набор элементов, применимых к карте.|
...
Office 365 Соединитетельные карты правильно функционируют в Microsoft Teams, включая [ `ActionCard` действия.](/outlook/actionable-messages/card-reference#actioncard-action)
