...
### <a name="aad-object-id-and-upn-in-user-mention"></a>AAD объекта и UPN в упоминаемом пользователем 
...
| Имя участника-пользователя | Бот, соединитель | AAD пользователя upN | john.smith@microsoft.com |
...
Чтобы замаскировать сведения в адаптивных картах, добавьте свойство для введите и установите `style`  `input.text` его значение **пароль**.
