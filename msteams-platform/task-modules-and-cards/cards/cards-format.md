...
description: В этом модуле вы узнаете, что такое форматирование текста карточек в Microsoft Teams, и отформатируете карточки с помощью Markdown.
...
Вы можете включить встроенный рисунок в любую карточку Teams. Поддерживаемые форматы изображений: PNG, JPG, GIF. Используйте размеры в пределах 1024 x 1024 пикселей и размер файла менее 1 МБ. GIF с анимацией не поддерживаются. Дополнительные сведения см. в разделе [Типы карточек](./cards-reference.md#inline-card-images).
...
:::image type="content" source="../../assets/images/Cards/Adaptive-markdown-desktop-client.png" alt-text="адаптивный клиент для рабочего стола markdown":::

В iOS форматирование Markdown для адаптивных карточек отображается следующим образом:

:::image type="content" source="../../assets/images/Cards/Adaptive-markdown-iOS-75.png" alt-text="Форматирование Markdown для адаптивных карточек в iOS":::

В Android форматирование Markdown для адаптивных карточек отображается следующим образом:

:::image type="content" source="../../assets/images/Cards/Adaptive-markdown-Android.png" alt-text="Форматирование Markdown для адаптивных карточек в Android":::
...
:::image type="content" source="../../assets/images/Cards/adaptive-card-emoji.png" alt-text="Адаптивная карточка эмодзи":::

### <a name="mention-support-within-adaptive-cards"></a>Поддержка упоминаний в адаптивных карточках

Вы можете добавить @упоминания в текст адаптивной карточки для ботов и ответов расширения для обмена сообщениями. Чтобы добавить @упоминания в карточки, используйте ту же логику уведомления и отрисовки, что и в [упоминаниях на основе сообщений в беседах в каналах и групповых чатах](../../bots/how-to/conversations/channel-and-group-conversations.md#work-with-mentions).

Боты и расширения для обмена сообщениями могут включать упоминания в содержимом карточки в элементах [TextBlock](https://adaptivecards.io/explorer/TextBlock.html) и [FactSet](https://adaptivecards.io/explorer/FactSet.html).
...
:::image type="content" source="../../assets/images/authentication/user-mention-in-bot.png" alt-text="Упоминание пользователя в боте с адаптивной карточкой":::
...
:::image type="content" source="../../assets/images/authentication/user-mention-in-incoming-webhook.png" alt-text="Упоминание пользователя во входящем веб-перехватчике":::
...
:::image type="content" source="../../assets/images/Cards/masking-information-view.png" alt-text="Представление маскировки сведений":::
...
:::image type="content" source="../../assets/images/Cards/full-width-adaptive-card.png" alt-text="Представление полноширинной адаптивной карточки":::
...
:::image type="content" source="../../assets/images/Cards/small-width-adaptive-card.png" alt-text="Представление адаптивной карточки с небольшой шириной":::
...
:::image type="content" source="../../assets/images/Cards/adaptivecard-hover-expand-icon.png" alt-text="Адаптивная карточка с расширяемым изображением":::
...
:::image type="content" source="../../assets/images/Cards/adaptivecard-expand-image.png" alt-text="Изображение, развернутое для представления &quot;Экран&quot;":::
...
:::image type="content" source="../../assets/images/Cards/connector-desktop-markdown-combined.png" alt-text="Форматирование Markdown для карточек соединителей":::

В iOS форматирование Markdown для карточек соединителей отображается следующим образом:

:::image type="content" source="../../assets/images/Cards/connector-iphone-html-combined-80.png" alt-text="Форматирование Markdown для карточек соединителей в клиенте iOS":::
...
:::image type="content" source="../../assets/images/Cards/connector-android-markdown-combined.png" alt-text="Форматирование Markdown для карточек соединителей в клиенте Android":::
...
:::image type="content" source="../../assets/images/Cards/Connector-desktop-html-combined.png" alt-text="Форматирование HTML для карточек соединителей в классическом клиенте":::

В iOS форматирование HTML отображается следующим образом:

:::image type="content" source="../../assets/images/Cards/connector-iphone-html-combined-80.png" alt-text="Форматирование HTML для карточек соединителей в клиенте iOS":::
...
:::image type="content" source="../../assets/images/Cards/connector-android-html-combined.png" alt-text="Форматирование HTML для карточек соединителей в клиенте Android":::
...
:::image type="content" source="../../assets/images/Cards/card-formatting-xml-desktop-v2.png" alt-text="Форматирование HTML в классическом клиенте":::

В iOS форматирование HTML отображается следующим образом:

:::image type="content" source="../../assets/images/Cards/card-formatting-xml-mobile-v2.png" alt-text="Форматирование HTML в клиенте iOS":::

Форматирование знаков, например полужирный шрифт и курсив, не отображается в iOS.

В Android форматирование HTML отображается следующим образом:

:::image type="content" source="../../assets/images/Cards/card-formatting-xml-android-60.png" alt-text="Форматирование HTML в клиенте Android":::
...
* [Обозреватель схемы для адаптивных карточек](https://adaptivecards.io/explorer/TextBlock.html)
