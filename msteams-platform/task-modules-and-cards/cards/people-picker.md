...
ms.locfileid: "66503489"
---
# <a name="people-picker-in-adaptive-cards"></a>Выбор людей в адаптивных карточках

>[!NOTE]
> В настоящее время средство выбора людей в адаптивных карточках доступно в общедоступной предварительной версии разработчика [для Teams](../../resources/dev-preview/developer-preview-intro.md#public-developer-preview-for-teams) только для мобильных устройств и общедоступной версии для настольных компьютеров.
...
> [!NOTE]
> В настоящее время эта функция доступна в  [общедоступной предварительной версии для разработчиков только для Teams](../../resources/dev-preview/developer-preview-intro.md#public-developer-preview-for-teams) .
