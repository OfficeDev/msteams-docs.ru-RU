...
### <a name="type-ahead-search-in-adaptive-cards"></a>Поиск заранее в адаптивных картах  

Введите предварительный поиск, добавленный в [](~/task-modules-and-cards/cards/dynamic-search.md) качестве управления входом в Адаптивные карты, введите динамический поиск с динамически загруженным набором данных. Это также позволяет пользователям делать статичный поиск по типу в списке с ограниченным количеством вариантов. Мобильные и настольные клиенты поддерживают динамический поиск. 
