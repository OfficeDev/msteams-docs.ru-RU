...
* **Боковая** панель: пользователь может открыть боковую панель в любое время во время собрания для чата, просмотра списка или использования приложения (то есть вкладки "Собрание"). Этап динамически изменяет порядок при открытии панели.
...
Если боковая панель не открыта, ее размер по умолчанию — 994 x 678 пикселей и не менее 792 x 382 пикселя.
...
Так как диалоги находятся в центре стадии собрания, выполнение задачи должно быть быстрым и простым, чтобы избежать проблем пользователей.
...
Если на вкладке собрания несколько уровней навигации, пользователи должны иметь возможность вернуться к своим предыдущим представлениям.
...
> [!div class="nextstepaction"]
> [Настройка приложения для собраний](~/apps-in-teams-meetings/build-tabs-for-meeting.md)
