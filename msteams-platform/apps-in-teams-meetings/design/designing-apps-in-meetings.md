...
> [!NOTE]
> В настоящее время, если приложение разделено на сцене на рабочем столе, оно будет показываться только для пользователей на мобильных собраниях.
