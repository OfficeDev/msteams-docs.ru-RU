...
description: Узнайте, как спроектировать приложения на Teams собраниях и получить Microsoft Teams пользовательского интерфейса, вкладку на собрании, варианты использования, адаптивный режим, общую стадию собрания, тему и навигацию.
ms.author: lajanuar
ms.localizationpriority: medium
ms.topic: conceptual
keywords: Шаблон пакета пользовательского интерфейса на этапе общего собрания с адаптивным поведением
ms.openlocfilehash: 5688e858fda4aa90fb4bfa75ca70c145308d97ca
ms.sourcegitcommit: 5070746e736edb4ae77cd3efcb2ab8bb2e5819a0
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 06/16/2022
ms.locfileid: "66123001"
---
...
Более подробные рекомендации по проектированию, включая элементы, которые можно захватывать и изменять по мере необходимости, можно найти в Microsoft Teams пользовательского интерфейса.
...
Пользователи могут добавлять расширение собрания до и во время собраний. Они также могут добавить приложение для определенного собрания непосредственно из Teams магазина.
...
Используйте один из следующих Teams пользовательского интерфейса для разработки вкладки собрания:
...
Диалоговые окна собрания отображаются на Teams собрания. Они требуют внимания пользователя, подтверждения или взаимодействия, но являются незаметными и не прерывают собрание. Их следует использовать с осторожностью и для сценариев, ориентированных на светлый и ориентированный на задачи.
...
* Краткое исследование или опрос
...
|----------|-----------|
|1|**Значок приложения**: выделенный значок указывает, что открыта вкладка приложения на собрании.|
|2|**Кнопка "Поделиться собранием"**: точка входа для совместного использования приложения на собрании. Для согласованного взаимодействия всегда используйте стандартный значок Teams общего доступа. **Общий доступ к собранию** — это рекомендуемый текст по умолчанию, но вы также можете настроить его для вариантов использования. Например, вместе **можно воспроизводить** игровое приложение или **смотреть** видео. В любом случае убедитесь, что действие создаст общий интерактивный интерфейс для всех участников собрания.|
|3|**Атрибут докладчика**: отображает имя участника, который предоставил общий доступ к приложению.|
|4|**iframe.** Отображает содержимое приложения.|
|5|**Кнопка "Остановить общий доступ"**: прекращается предоставление общего доступа к приложению на этапе собрания. Отображается только для участника, который запустил общую папку.|
...
Пользователи ожидают вертикальной прокрутки в Teams (и в другом месте). Это может не применяться, если у вас есть творческий холст, например доска, которую пользователи могут просматривать по оси X и Y.
...
Teams оптимизированы для темной темы, чтобы уменьшить визуальный и когнитивный шум, чтобы пользователи могли сосредоточиться на обсуждении и общем содержимом. Помните, что некоторым типам приложений (например, доска и редактирование документов) не требуется темный холст.
...
Цвета, которые конфликтуют со средой собрания, могут отвлекать и выглядеть менее Teams. Сведения о Teams [цветов](https://developer.microsoft.com/fluentui#/styles/web/colors/products), включая нейтральные темы вызовов.
