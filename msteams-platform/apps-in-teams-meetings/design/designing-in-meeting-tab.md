...
Собрания Teams оптимизированы для темного режима, что позволяет снизить визуальное и пользовательское шум, чтобы пользователи могли сосредоточиться на обсуждении и общем содержимом. Вкладка "на собрании" должна применять темную тему и следовать рекомендациям.
