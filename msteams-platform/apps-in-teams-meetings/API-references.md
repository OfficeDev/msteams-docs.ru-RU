...
Расширяемость собраний предоставляет API для расширения возможностей собраний. С помощью перечисленных API можно выполнить следующее:
...
| **404** | Собрание закончилось, или участники недоступны.|
...
| **1000** | Приложение не имеет надлежащих разрешений, чтобы разрешить общий доступ к сцене|
...
|---|---|
| **500** | Внутренняя ошибка. |
| **1000** | Приложение не имеет разрешений, чтобы разрешить совместное использование на сцене.|
