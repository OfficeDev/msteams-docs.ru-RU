...
> [!NOTE] 
> Проверьте, соответствует ли ваше приложение всем необходимым требованиям, указанным в Необходимые условия для приложений [в Teams собраниях.](~/apps-in-teams-meetings/create-apps-for-teams-meetings.md)
