...
|[**Сведения о собрании**](#get-meeting-details-api)| Получите статичные метаданные собрания. |Bot SDK |
...
|[**Получить состояние общего доступа к контенту приложений**](#get-app-content-stage-sharing-state-api)| Извлечение сведений о состоянии общего доступа к приложениям на стадии собрания. |MSTC SDK|
|[**Получите возможности совместного доступа к контенту на этапе приложения**](#get-app-content-stage-sharing-capabilities-api)| Извлечение возможностей приложений для общего доступа на стадию собрания. |MSTC SDK|
|[**Получить в режиме реального времени Teams собрания**](#get-real-time-teams-meeting-events-api)|Извлечение событий собраний в режиме реального времени, таких как фактическое время начала и окончания.| Bot SDK|
...
## <a name="send-real-time-captions-api"></a>Отправка API подписей в режиме реального времени
