...
|---|---|----|---|
|**meetingId**| String | Да | Идентификатор собрания доступен с помощью Bot Invoke и Teams клиентской SDK.|
...
|Значение|Тип|Обязательный|Описание|
|---|---|----|---|
|**callback**| String | Да | Callback содержит два параметра: ошибка и результат. Ошибка *может* содержать ошибку типа *SdkError* или null при успешном совместном окне. В результате может содержаться `AppContentStageSharingState` объект, указывающий на успешное и повторное и повторное, или null, указывающий на неудачное и повторное.|
