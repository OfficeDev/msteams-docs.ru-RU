...
Перед использованием API сведений о собраниях необходимо получить необходимые разрешения RSC. Манифест приложения должен иметь следующие веб-приложенияInfo:
...
#### <a name="pre-requisite"></a>Предварительное требование
Манифест приложения должен иметь следующие веб-приложенияInfo для успешного получения событий начала и окончания собрания.
