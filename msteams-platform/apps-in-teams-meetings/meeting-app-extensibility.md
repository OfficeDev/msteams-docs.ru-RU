...
author: surbhigupta
description: Узнайте о Teams жизненном цикле собраний и пользовательском интерфейсе собраний в среде для настольных и мобильных устройств, ролях и типах участников и пользователей, интеграции ботов и расширений сообщений в жизненный цикл собрания.
ms.topic: conceptual
...
Жизненный цикл собрания состоит из взаимодействия с приложением перед собранием, во время собрания и после собрания. В каждом этапе жизненного цикла собрания можно интегрировать вкладки, боты и расширения сообщений.
...
| Тип пользователя | Вкладки | боты; | Расширения сообщений | Адаптивные карточки | Модули задач | Диалоговое окно собрания | Сцена собрания |
| :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |
