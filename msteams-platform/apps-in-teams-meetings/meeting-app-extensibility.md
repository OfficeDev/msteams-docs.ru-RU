...
author: surbhigupta
description: Узнайте о Teams жизненном цикле собраний и пользовательском интерфейсе собраний в настольной и мобильной среде, ролях и типах участников и пользователей, интеграции ботов и расширения обмена сообщениями в жизненный цикл собрания.
ms.topic: conceptual
...
* На собрании существуют три различные роли: организатор, докладчик и участник. Дополнительные сведения см. [в разделе ролей Teams собрания](https://support.microsoft.com/office/roles-in-a-teams-meeting-c16fa7d0-1666-4dde-8686-0a0bfe16e019).  
...
В этой статье рассматриваются сведения о жизненном цикле собраний и интеграции вкладок, ботов и расширений обмена сообщениями. Он определяет различные роли участников и типы пользователей.
...
> [!IMPORTANT]
> Если вы интегрировали вкладку с собранием, ваше приложение должно следовать Teams проверки подлинности единого входа для [вкладок](../tabs/how-to/authentication/auth-aad-sso.md).
...
1. Выберите **вкладку "Сведения** " и нажмите кнопку <img src="~/assets/images/apps-in-meetings/plusbutton.png" alt="Plus button" width="30"/>. Появится галерея вкладок.
...
Чтобы реализовать расширение обмена сообщениями, начните с создания расширения для обмена [сообщениями, а](../messaging-extensions/how-to/create-messaging-extension.md) затем продолжайте создавать приложения для Teams [собраний](../apps-in-teams-meetings/API-references.md#meeting-apps-api-references).
...
* **Участник**: участник — это пользователь, приглашенный для участия в собрании. Участники имеют ограниченные возможности во время собрания, такие как:
  ...
  * Они могут просматривать и взаимодействовать с приложением вкладки на этапе собрания без установки приложения или без каких-либо прав приложения.
...
Дополнительные сведения см. [в разделе ролей Teams собрания](https://support.microsoft.com/office/roles-in-a-teams-meeting-c16fa7d0-1666-4dde-8686-0a0bfe16e019).
...
| Тип пользователя | Вкладки | боты; | расширения для обмена сообщениями; | Адаптивные карточки | Модули задач | Диалоговое окно собрания | Этап собрания |
| :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- |
...
| Гость, в который входит клиент Azure AD | Взаимодействие разрешено. Создание, обновление и удаление не разрешены. | Недоступно | Недоступно | Взаимодействие в чате собрания разрешено. | Взаимодействие в чате собрания из адаптивной карточки разрешено. | Доступно | Может запускать, просматривать и взаимодействовать с приложением на этапе собрания |
| Федеративные пользователи. Дополнительные сведения см. в статье о [нестандартных пользователях](/microsoftteams/non-standard-users). | Взаимодействие разрешено. Создание, обновление и удаление не разрешены. | Взаимодействие разрешено. Приобретение, обновление и удаление не разрешены. | Недоступно | Взаимодействие в чате собрания разрешено. | Взаимодействие в чате собрания из адаптивной карточки разрешено. | Взаимодействие в чате собрания разрешено. | Может [запускать](~/apps-in-teams-meetings/API-references.md?tabs=dotnet#share-app-content-to-stage-api) (через API пакета SDK), просматривать и взаимодействовать с приложением на этапе собрания |

## <a name="next-step"></a>Следующий этап

> [!div class="nextstepaction"]
> [Включение и настройка приложений для Teams собраний](enable-and-configure-your-app-for-teams-meetings.md)
