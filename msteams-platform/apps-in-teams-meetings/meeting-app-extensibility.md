...
author: surbhigupta
description: Сведения о жизненном цикле собраний, создании взаимодействия с пользователем на протяжении всего жизненного цикла собрания в среде для настольных и мобильных устройств, ролях участников и типах пользователей. Кроме того, вы узнаете об интеграции ботов и расширения сообщений в жизненный цикл собрания.
ms.topic: conceptual
...
#### <a name="to-add-tabs-to-an-existing-meeting"></a>Добавление вкладок в существующее собрание
...
1. Выберите вкладку **Сведения** и нажмите <img src="~/assets/images/apps-in-meetings/plusbutton.png" alt="Plus button" width="30"/>. Появится галерея вкладок.
    ...
    :::image type="content" source="~/assets/images/apps-in-meetings/PreMeeting.png" alt-text="Интерфейс приложения перед собранием.":::
...
:::image type="content" source="~/assets/images/apps-in-meetings/mobilepremeeting.png" alt-text="Предварительные собрания на мобильных устройствах":::

---

#### <a name="in-meeting-app-experience"></a>Взаимодействие с приложением во время собрания

Благодаря взаимодействию с приложением во время собрания вы можете привлекать участников во время собрания с помощью приложений и диалогового окна на собрании. Приложения для собраний располагаются на панели инструментов окна собрания в виде вкладки во время собрания. Используйте диалоговое окно во время собрания для демонстрации полезного контента участникам собрания. Дополнительные сведения см. в [статье о создании приложений для собраний Teams](create-apps-for-teams-meetings.md).
...
:::image type="content" source="~/assets/images/apps-in-meetings/mobile-in-meeting-dialog-view.png" alt-text="Представление мобильного диалогового окна":::
...
:::image type="content" source="~/assets/images/apps-in-meetings/in-meeting-dialog1.png" alt-text="Боковая панель собрания":::

# <a name="mobile"></a>[Мобильные устройства](#tab/mobile)

:::image type="content" source="~/assets/images/apps-in-meetings/sidepanelmobile.png" alt-text="Мобильный телефон боковой панели в собрании":::
...
Однако экземпляры вкладок в собрании канала отделены от вкладок в самом канале. Например, предположим, что в канале "Разработка" есть вкладка "Polly". Если вы создаете собрание Standup в этом канале, на этом собрании не будет вкладки Polly, пока вы явно не добавите вкладку [к собранию](#to-add-tabs-to-an-existing-meeting).

В собраниях общедоступного запланированного канала после добавления вкладки собрания к ней можно получить доступ со страницы сведений о собрании, выбрав объект собрания. Пример приведен в следующей статье:
...
Боты, включенные в области `groupchat` , начинают работать на собраниях. Чтобы реализовать боты, начните [с создания бота](../build-your-first-app/build-bot.md) , а затем продолжайте создавать [приложения для собраний Teams](../apps-in-teams-meetings/API-references.md#meeting-apps-api-references).
...
* **Участник**: участник приглашен для участия в собрании, но не может выступать в качестве докладчика. Участники могут взаимодействовать с другими участниками собрания, но не могут управлять параметрами собрания или делиться содержимым.
...
Типы пользователей, такие как организатор, выступающий или участник собрания, могут быть [участниками собрания](#participant-roles-in-a-meeting).
...
| Гость, часть клиентского Azure AD | Взаимодействие разрешено. Создание, обновление и удаление не разрешены. | Недоступно | Недоступно | Взаимодействие в чате собрания разрешено. | Взаимодействие в чате собрания из адаптивной карточки разрешено. | Доступно | Может запускать, просматривать и взаимодействовать с приложением на этапе собрания только на настольном клиенте Teams и на мобильном устройстве Teams. |
| Федеративные пользователи. Дополнительные сведения см. в статье о [нестандартных пользователях](/microsoftteams/non-standard-users). | Взаимодействие разрешено в запланированных собраниях. Создание, обновление и удаление не разрешены. | Взаимодействие разрешено. Приобретение, обновление и удаление не разрешены. | Недоступно | Взаимодействие в чате собрания разрешено. | Взаимодействие в чате собрания из адаптивной карточки разрешено. | Недоступно | Может запускать, просматривать и взаимодействовать с приложением на этапе собрания только на настольном клиенте Teams и на мобильном устройстве Teams. |
...
> * На мобильных устройствах анонимные пользователи не смогут получить доступ к приложениям на запланированных собраниях общедоступного канала.
