...
✔ табули должна быть в уорганизованном состоянии при более чем десяти опросах или опросах.
...
> [!NOTE]
> Если манифест _приложения указывает,_ что вкладка оптимизирована для боковой [панели,](create-apps-for-teams-meetings.md#during-a-meeting)она будет отображаться там. Она также может быть частью работы с совместной работы с учетом указанных рекомендаций по проектированию.
...
Вы можете получить доступ  **к странице параметров** собрания следующим образом:

&#11200; в Teams перейдите в **календарь** с логотипом, выберите собрание, а затем ![ ](../assets/images/apps-in-meetings/calendar-logo.png) **параметры собрания.**
