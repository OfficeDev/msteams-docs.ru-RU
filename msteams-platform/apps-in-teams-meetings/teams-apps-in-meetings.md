...
> **Note**: Если _манифест приложения_ указывает, что вкладка [оптимизирована для боковой панели](create-apps-for-teams-meetings.md#in-meeting), то она будет отображаться. Я также могу быть участником области использования общих папок в соответствии с указанными рекомендациями по проектированию.
...
1. **Гость**. Гость — это участник другой организации, который был приглашен на доступ к Teams и другим ресурсам в клиенте Организации. Гости добавляются в Active Directory вашей организации, и им могут быть предоставлены почти все возможности Teams в качестве собственного члена группы с полным доступом к разговорам групп, собраниям и файлам. _Просмотр_ [доступного для подбора в Microsoft Teams](/microsoftteams/guest-access)
