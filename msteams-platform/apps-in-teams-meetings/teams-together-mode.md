...
* Места зарезервированы для организатора собрания и выступающих. Выступающий не ссылается на пользователя, который активно делится информацией. Это относится к [роли собрания](https://support.microsoft.com/office/roles-in-a-teams-meeting-c16fa7d0-1666-4dde-8686-0a0bfe16e019).
...
Чтобы создать сцену с помощью студии Scene, выполните следующие действия.
...
1. Выберите **Сохранить** и нажмите **Просмотреть в Teams**, чтобы быстро протестировать сцену в Teams.
    ...
    * При выборе **Просмотреть в Teams** автоматически создается приложение Teams, которое можно просмотреть на странице **Приложения** на портале разработчика Teams.
...
Чтобы выбрать сцену и активировать настраиваемые сцены режима "Вместе", выполните следующие действия.

1. Создание тестового собрания.

    >[!NOTE]
    > При выборе **предварительного просмотра** в студии Scene сцена устанавливается как приложение в Teams. Это модель, по которой разработчик может тестировать и опробовать сцены из студии Scene. После отправки сцены в виде приложения пользователи видят эти сцены в галерее сцен.
...
1. Выберите **Применить**. Teams устанавливает приложение для пользователя и применяет сцену.
