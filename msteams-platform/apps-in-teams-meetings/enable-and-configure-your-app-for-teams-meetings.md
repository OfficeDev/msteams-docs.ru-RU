...
* [Предварительная встреча](#pre-meeting)
* [В собрании](#in-meeting)
* [После собрания](#post-meeting)

### <a name="pre-meeting"></a>Предварительная встреча
...
### <a name="in-meeting"></a>В собрании
...
> * Чтобы использовать эту функцию, приложение должно поддерживать собрание на собранииSidePanel.
...
### <a name="post-meeting"></a>После собрания

Конфигурации после собрания и [предварительного](#pre-meeting) собрания одинаковы.
