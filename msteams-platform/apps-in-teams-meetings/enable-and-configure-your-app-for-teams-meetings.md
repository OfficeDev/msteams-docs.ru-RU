...
Приложения для Teams собраний могут расширить возможности своих приложений на протяжении всего жизненного цикла собраний. Прежде чем работать с приложениями для Teams собраний, необходимо выполнить следующие условия:

* Умейте разрабатывать Teams приложения. Дополнительные сведения о разработке приложения Teams см. в Teams [разработки приложения](../overview.md).
...
* Соблюдайте общие [Teams правил](../tabs/design/tabs.md) разработки вкладок для сценариев до и после собрания. Для работы во время собраний обратитесь к рекомендациям по проектированию вкладок на собрании и рекомендациям по проектированию [диалогов на собрании](../apps-in-teams-meetings/design/designing-apps-in-meetings.md#use-an-in-meeting-dialog).[](../apps-in-teams-meetings/design/designing-apps-in-meetings.md#use-an-in-meeting-tab)

* Чтобы ваше приложение обновлялось в режиме реального времени, оно должно быть обновлено в зависимости от событий на собрании. Эти события могут быть в диалоговом окне собрания и на других этапах жизненного цикла собрания. В диалоговом окне на собрании `completionBotId` см. параметр в полезной нагрузке уведомления на [собрании](API-references.md#send-an-in-meeting-notification).
...
Поддержка области `groupchat` , чтобы включить приложение в чаты перед собранием и после собрания. С помощью предварительного собрания приложения можно найти и добавить приложения для собраний и выполнять задачи перед собранием. С помощью приложения после собрания можно просмотреть результаты собрания, такие как результаты опроса или плата.
 ...
 Ниже ниже 10 `context` значений для свойства, из которого можно использовать все или некоторые из этих значений:
...
> [!NOTE]
> * Чтобы поделиться определенными частями приложения на этап, Teams манифест версии 1.12 или более поздней версии.
> * Делиться определенными частями приложения до стадии поддерживается только для Teams настольных компьютеров.
