...
| **meetingChatTab** | Вкладка в загонах группового чата между набором пользователей в контексте запланированного собрания. Вы можете указать **собраниеChatTab** или **meetingDetailsTab,** чтобы обеспечить работу приложений на мобильных устройствах. |
...
| **meetingStage** | Приложение из meetingSidePanel можно использовать на стадии собрания. Эта вкладка не поддерживается на мобильном устройстве. |
