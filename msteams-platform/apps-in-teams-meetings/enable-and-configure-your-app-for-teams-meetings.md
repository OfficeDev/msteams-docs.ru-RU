...
* [Поделитесь всем приложением, чтобы этап](#share-entire-app-to-stage) с помощью кнопки share to stage в Teams клиенте.
...
Чтобы поделиться всем приложением с этапом, в манифесте приложения необходимо настроить и `meetingStage` `meetingSidePanel` в качестве контекста кадра. Например:
