...
* Используйте приложение, которое поддерживает настраиваемые вкладки в области `groupchat` . Дополнительные сведения см. в разделе об [области группового чата](../resources/schema/manifest-schema.md#configurabletabs) и [создании вкладки группы](../build-your-first-app/build-channel-tab.md).
...
| **meetingStage** | Приложение из `meetingSidePanel` можно продемонстрировать на сцене собрания. Это приложение нельзя использовать на клиентах комнат Teams. |
...
1. Перейдите **на вкладку** "Сведения" и выберите "Снимок экрана" с описанием использования значка кнопки "плюс" на вкладке "Сведения" для установки :::image type="content" source="../assets/images/apps-in-meetings/plusbutton.png" alt-text="приложения в качестве вкладки":::.

   :::image type="content" source="../assets/images/apps-in-meetings/premeeting.png" alt-text="На снимке экрана показано, как установить приложение в виде вкладки на вкладке перед собранием в собрании Teams.":::
...
> [!NOTE]
> Общий доступ ко всему приложению на этапе собрания на мобильных устройствах в настоящее время доступен только в [общедоступной предварительной версии для разработчиков](../resources/dev-preview/developer-preview-intro.md).

# <a name="desktop"></a>[Компьютер](#tab/Desktop)

:::image type="content" source="../assets/images/apps-in-meetings/share_to_stage_during_meeting.png" alt-text="На снимке экрана показано, как поделиться всем приложением на этапе совместной работы на рабочем столе.":::

# <a name="mobile"></a>[Мобильные устройства](#tab/mobile)

:::image type="content" source="../assets/images/share-apps-in-teams-meeting.PNG" alt-text="На снимке экрана показано, как поделиться всем приложением на этапе совместной работы на мобильных устройствах.":::
...
:::image type="content" source="../assets/images/apps-in-meetings/share-specific-content-to-stage.png" alt-text="На снимке экрана показано, как поделиться определенной частью приложения с этапом собрания в собрании Teams.":::
...
* Выполните [пошаговое руководство,](../sbs-meetings-sidepanel.yml) чтобы создать sidePanel собрания в собрании Teams.
