...
1. Чтобы просмотреть страницу конфигурации вкладок, перейдите к `http://localhost:3007/<yourDefaultAppNameTab>/config.html`. Ниже показано:
...
1. Следуйте указаниям для добавления вкладки. Существует настраиваемый диалоговое окно конфигурации для вашего канала или вкладки группы.
1. Выберите **Сохранить** и вкладка добавляется в вкладку канала.
    ...
    Теперь вы создали и добавили вкладку канала или группы в Teams.
...
1. Откройте Visual Studio Обозреватель решений и перейдите в папку **PagesShared**  > **и откройте _Layout.cshtml** и добавьте следующее в <head> Раздел тегов:
...
1. В Visual Studio Обозреватель решений перейдите в папку **Страницы** и откройте **Tab.cshtml**
...
1. В Visual Studio выберите **F5** или **выберите Пуск** отладки из меню **отладки**.
...
1. В **функции App** выберите приложение Group и channel. Обновите **URL-адрес конфигурации** и `https://<yourngrokurl>/tab` выберите область **вкладки**.
...
1. Выберите **Добавить в команду** , чтобы настроить вкладку в команде. Настройте вкладку и выберите **Сохранить**. Вкладка теперь доступна в Teams.
...
1. Откройте Visual Studio Обозреватель решений и перейдите в папку **ViewsShared**  > **и откройте _Layout.cshtml** и добавьте следующее в <head> Раздел тегов:
...
1. В Visual Studio Обозреватель решений перейдите в папку **Tab** и откройте **Tab.cshtml**
