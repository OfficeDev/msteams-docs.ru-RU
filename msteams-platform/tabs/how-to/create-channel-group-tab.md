...
author: laujan
description: Руководство quickstart по созданию вкладки канала и группы с генератором Yeoman для Microsoft Teams, включая обзор исходных кодов с примерами кода.
...
Вы можете создать вкладку канала или группы с Node.js и генератора Yeoman, ASP. NETCore или ASP. MVC NETCore.
...
1. На левой области выберите эллипсы, &#x25CF;&#x25CF;&#x25CF; рядом с командой, используемой для тестирования вкладки, и выберите **команду Manage**.
1. В главной области выберите Приложения из  панели **вкладок** и выберите Upload настраиваемого приложения, расположенного в правом нижнем углу страницы.
...
Эти файлы необходимо использовать в пакете приложений для загрузки вкладки в Teams. Когда пользователь выбирает добавить или обновить вкладку, `configurationUrl` Microsoft Teams загружает указанные в манифесте, встраив ее в IFrame и отрисовывает ее на вкладке.
...
* Общий доступ. Частичная разметка **представления _Layout.cshtml** содержит общую структуру страниц приложения и общие визуальные элементы. Он также будет ссылаться на Teams библиотеку.
