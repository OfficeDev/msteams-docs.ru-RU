...
1. Перейдите Teams и выберите **"Приложения**&nbsp; :::image type="content" source="~/assets/images/tab-images/store.png" alt-text="Teams Store&quot;":::.
...
Эти файлы нужно заархивировать в пакете приложения для использования при загрузке вкладки в Teams. Когда пользователь выбирает добавление или обновление вкладки, `configurationUrl` Teams загружает указанный манифест, внедряет ее в IFrame и отображает на вкладке.
...
1. Перейдите к Teams. Если вы используете [веб-версию](https://teams.microsoft.com), вы можете проверить код интерфейсной части с помощью [средств для разработчиков](~/tabs/how-to/developer-tools.md).
