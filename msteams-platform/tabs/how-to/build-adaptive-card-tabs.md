...
author: KirtiPereira
description: Узнайте, как создавать вкладки с помощью адаптивных карточек, где внешний интерфейс отрисовывается с помощью адаптивных карточек, а серверная часть работает на основе бота. Изучение действий вызова и обработка отправки.
ms.topic: conceptual
