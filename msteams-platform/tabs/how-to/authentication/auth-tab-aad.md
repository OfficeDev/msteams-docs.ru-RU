...
ms.locfileid: "65887781"
---
# <a name="configure-third-party-oauth-authentication"></a>Настройка проверки подлинности OAuth сторонних производителей
...
В последнем разделе вы вызвали службу авторизации Azure AD и передали сведения о пользователе и приложении, чтобы Azure AD мог предоставлять пользователю собственный монолитный интерфейс авторизации. Ваше приложение не контролирует, что происходит в этом интерфейсе. Приложению известно только, что возвращается, когда Azure AD вызывает предоставленную вами страницу обратного вызова (`/tab-auth/simple-end`).
