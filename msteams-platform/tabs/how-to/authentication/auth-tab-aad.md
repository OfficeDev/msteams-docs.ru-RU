...
description: Из этой статьи вы узнаете, Teams вкладки Microsoft Azure AD проверки подлинности, проверку подлинности в Teams и как использовать ее на вкладке.
ms.topic: how-to
...
ms.locfileid: "66142271"
---
# <a name="configure-third-party-oauth-authentication"></a>Настройка проверки подлинности OAuth сторонних производителей

> [!Note]
> Для работы проверки подлинности на вкладке на мобильных клиентах убедитесь, что вы используете версию 1.4.1 или более позднюю версию пакета SDK Teams JavaScript.
