...
> **Быстрый запуск**  
>
> Самый простой путь к началу работы с ВХОДом в систему с помощью набора инструментов Microsoft Teams для Visual Studio Code. [Подробнее](../../../toolkit/visual-studio-code-tab-sso.md)
