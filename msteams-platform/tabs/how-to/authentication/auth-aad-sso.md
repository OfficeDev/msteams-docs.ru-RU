...
1. На вкладке выполняется вызов JavaScript в `getAuthToken()`. Это Teams получить маркер проверки подлинности для приложения вкладки.
