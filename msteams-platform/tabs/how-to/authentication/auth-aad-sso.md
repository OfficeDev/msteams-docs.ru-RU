...
12. Перейдите к разделу **разрешения API**. Выберите *Добавить разрешение*,  >  *Microsoft Graph*  >  *делегированные разрешения*Microsoft Graph, а затем добавьте следующие разрешения:
...
Поздравляем! Вы завершили регистрацию приложения пререкуситиес, чтобы перейти к приложению единого входа для вкладки.     
