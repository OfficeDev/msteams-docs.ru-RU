...
13. Переход к **проверке подлинности**
    ...
    * Выберите **веб**.
    * Введите **универсальный код ресурса (URI) перенаправления** для вашего приложения. Это будет страница, на которой успешный неявный поток предоставления перенаправит пользователя.

    Чтобы включить неявное предоставление, установите следующие флажки:  
