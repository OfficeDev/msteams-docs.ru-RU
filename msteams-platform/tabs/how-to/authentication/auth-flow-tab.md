...
3. Затем вкладка вызывает `microsoftTeams.authentication.authenticate()` метод и регистрирует `successCallback` функции и `failureCallback` функции.
...
Пример кода, показывающий процесс проверки подлинности вкладок, см. в примере:

* [Пример проверки подлинности вкладок Teams (Node)](https://github.com/OfficeDev/microsoft-teams-sample-complete-node)
* [Пример проверки подлинности вкладок Teams (C#)](https://github.com/OfficeDev/microsoft-teams-sample-complete-csharp)
