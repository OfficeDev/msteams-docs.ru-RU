...
Создайте новую регистрацию приложения в Azure AD и предоставьте его (веб-API) с помощью областей (разрешений). Настройте доверительные отношения между открытым API в Azure AD и этим приложением. Это позволяет клиенту Teams получить маркер доступа от имени этого приложения и пользователя, вошедшего в систему. Вы можете добавить идентификаторы клиентов для доверенных мобильных, настольных и веб-приложений, которые вы хотите предварительно авторизовать.
...
- **Варианты с одним или несколькими клиентами**. Будет ли это приложение использоваться только в клиенте Microsoft 365, где оно зарегистрировано, или его будут использовать многие клиенты Microsoft 365? Приложения, написанные для одного предприятия, обычно являются однопользовательскими. Приложения, написанные независимым поставщиком программного обеспечения и используемые многими клиентами, должны быть многопользовательскими, чтобы каждый клиент клиента мог получить доступ к приложению.
...
1. Введите соответствующий идентификатор клиента для клиента Teams для приложений, которые вы хотите авторизовать для веб-приложения своего приложения.
    ...
    > [!NOTE]
    >
    > - Идентификаторы клиентов для мобильных, настольных и веб-приложений Teams — это фактические идентификаторы, которые следует добавить.
