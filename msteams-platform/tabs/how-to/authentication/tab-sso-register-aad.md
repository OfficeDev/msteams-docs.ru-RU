...
2. Щелкните **значок Регистрация приложений** экрана.
   ...
   :::image type="content" source="../../../assets/images/authentication/teams-sso-tabs/azure-portal.png" alt-text="Azure AD портала." border="true":::

   **Появится Регистрация приложений** страницы.

3. **Щелкните значок "+Создать регистрацию**".

    :::image type="content" source="../../../assets/images/authentication/teams-sso-tabs/app-registrations.png" alt-text="Новая страница регистрации на Azure AD Портале." border="true":::
...
4. Введите имя приложения, которое вы хотите отобразить для пользователя приложения. При необходимости это имя можно изменить на более позднем этапе.
    ...
    :::image type="content" source="../../../assets/images/authentication/teams-sso-tabs/register-app.png" alt-text="Страница регистрации приложения на Azure AD Портале." border="true":::
...
7. Нажмите **Зарегистрировать**.
    ...
    :::image type="content" source="../../../assets/images/authentication/teams-sso-tabs/app-created-msg.png" alt-text="Зарегистрируйте приложение на Azure AD Portal." border="true":::
...
1. Выберите **"Управление** > **манифестом** " на левой панели.
   ...
   :::image type="content" source="../../../assets/images/authentication/teams-sso-tabs/azure-portal-manifest.png" alt-text="Azure AD портала" border="true":::
