...
### <a name="steps-to-perform-authentication-to-external-browsers"></a>Действия по выполнению проверки подлинности для внешних браузеров

<!-- #### 1. Pass `isExternal` and placeholders in `url` -->
**1. Инициация внешнего процесса аутентификации**
...
**2. Ссылка Teams во внешнем браузере**
...
**3. Ответ сервера стороннего приложения**
...
**4. Перенаправление сервера стороннего приложения на указанный `url`**
...
**6. Ответ сервера стороннего приложения на Teams** 
...
**7. Создание прямой ссылки сторонним приложением**
 ...
 **8. Результаты успешного вызова Teams**
