...
author: surbhigupta
description: Создайте страницу конфигурации для сбора сведений от пользователя. Кроме того, можно получить контекстные данные для вкладок Microsoft Teams, узнать о проверке подлинности, изменить или удалить вкладки.
...
>[!NOTE]
>
>* У вас есть 30 секунд для завершения операции сохранения (обратный вызов `registerOnSaveHandler`) до истечения времени ожидания. По истечении времени ожидания появится общее сообщение об ошибке.
...
>* Убедитесь, что он уникален `entityId`. Повторяющиеся `entityId` перенаправления на первый экземпляр вкладки.
