...
* [Обновление манифеста для системы единого входа и предварительного просмотра приложения](../authentication/tab-sso-manifest.md)
* [Настройка проверки подлинности стороннего поставщика удостоверений OAuth](../authentication/auth-tab-aad.md)
* [Создание соединителей Office 365](../../../webhooks-and-connectors/how-to/connectors-creating.md)
