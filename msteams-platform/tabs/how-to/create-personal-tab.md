...
1. Укажите свои значения для ряда вопросов, запрашиваемых генератором Microsoft Teams для обновления **файла manifest.json**.
...
1. Откройте **файл manifest.json** из следующего расположения в Visual Studio Code:
