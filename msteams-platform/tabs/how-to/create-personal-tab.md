...
1. В обозревателе решений Visual Studio откройте **PersonalTab.cshtml** из папки **Страницы**, добавьте `app.initialize()` в `<script>` теги и сохраните.
...
1. В обозревателе решений Visual Studio откройте **PersonalTab.cshtml** из папки **Представления** > **PersonalTab**, добавьте `app.initialize()` в теги `<script>` и сохраните.
