...
Вы можете создать личную вкладку с помощью Node.js и генератора Yeoman, ASP.NET Core или ASP.NET Core MVC. Для личной вкладки на Microsoft Teams см. [вкладки на мобильных устройствах](~/tabs/design/tabs-mobile.md).
...
1. В редакторе кода создайте новый файл HTML **personal.htmlдобавьте следующую** разметку:
...
> [!IMPORTANT]
> После того как вкладка была загружена Microsoft Teams **ngrok** и успешно сохранена, ее можно просмотреть в Teams до окончания сеанса туннеля.
...
Вы можете создать настраиваемую личную вкладку с C# и ASP.NET Core страниц Razor. [App Studio](~/concepts/build-and-test/app-studio-overview.md) также используется для завершения манифеста приложения и развертывания вкладки Teams.
...
1. После получения исходных кодов перейдите Visual Studio откройте **проект или решение**.
...
Чтобы вкладка отображалась в Teams, необходимо включить Microsoft Teams **клиента JavaScript** `microsoftTeams.initialize()` и включить вызов после загрузки страницы. Ваша вкладка и приложение Teams взаимодействуют таким образом:
