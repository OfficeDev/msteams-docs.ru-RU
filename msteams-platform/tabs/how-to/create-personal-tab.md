...
> [!NOTE]
> **App Studio** можно использовать для редактирования файла **manifest.json** и отправки завершенного пакета в Teams. Вы также можете вручную изменить **manifest.json**. Если это так, убедитесь, что вы создайте решение снова, чтобы создатьTab.zip **файл** для загрузки.
