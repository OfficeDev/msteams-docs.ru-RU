...
В следующей таблице описывается доступность вкладок и поведение, когда приложение перечислены в Teams и утверждены для использования в мобильных устройствах.
