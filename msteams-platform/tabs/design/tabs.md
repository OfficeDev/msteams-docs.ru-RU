...
---
# <a name="designing-your-tab-for-microsoft-teams-desktop-and-web"></a>Разработка вкладки для Microsoft Teams рабочего стола и веб-страницы

Вкладка — это большое полотно для контента. Для руководства разработкой приложения в следующих сведениях описывается и иллюстрируется, как люди могут добавлять, использовать и управлять вкладками в Teams.
...
|3|**iframe**. Адаптивные пространства для контента вашего приложения. Например, параметры вкладки или проверка подлинности.|
...
Используйте один из следующих Teams пользовательского интерфейса для разработки интерфейса вкладки:
