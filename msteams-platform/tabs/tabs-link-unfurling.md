...
> [!NOTE]
> В Teams мобильных клиентов, привнося представление stage View для приложений, [распространяемых через Teams](/platform/concepts/deploy-and-publish/apps-publish-overview.md) магазине и не имеющих оптимизированного для мобли опыта, открывает веб-браузер устройства по умолчанию. Браузер открывает URL-адрес, указанный в `websiteUrl` параметре `TabInfo` объекта.
...
https://teams.microsoft.com/l/stage/be411542-2bd5-46fb-8deb-a3d5f85156f6/0?context={"contentUrl":"",websiteUrlhttps://teams-alb.wakelet.com/teams/collection/e4173826-5dae-4de0-b77d-bfabafd6f191":"https://teams-alb.wakelet.com/teams/collection/e4173826-5dae-4de0-b77d-bfabafd6f191?standalone=true",title":"Quotes:Miscellaneous","threadId":"19:9UryYW9rjwnq-vwmBcexGjN1zQSNX0Y4oEAgtUC7WI81@thread.tacv2"}
...
| `removeUrl?` | String | 2048 | Это свойство — https:// URL-адрес, который указывает на пользовательский интерфейс, отображаемый при удалении вкладки пользователем. Это необязательное поле.|
