...
description: Узнайте, как разработать расширение для обмена сообщениями Teams, и получить комплект пользовательского интерфейса Microsoft Teams.
keywords: рекомендации по разработке команд ссылки советы по расширению для обмена сообщениями лучшие практики
...
Расширения для обмена сообщениями могут содержать команды поиска, команды действия или и то, и другое. Какие именно нужны вам — зависит от функций вашего приложения и их соответствия сценариям использования Teams.
