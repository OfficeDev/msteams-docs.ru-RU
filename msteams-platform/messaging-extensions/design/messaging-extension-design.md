...
description: Узнайте, как разработать расширение для обмена сообщениями Teams, и получить комплект пользовательского интерфейса Microsoft Teams. Описание руководств по разработке Teams ссылки советы по расширению для сообщений рекомендации
