...
* **Статический список параметров**: это самый простой метод. Можно определить список параметров в манифесте приложения, который отображает клиент Teams, но в этом случае клиент Teams не может управлять форматированием.
