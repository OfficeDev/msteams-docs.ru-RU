...
Команды действий позволяют представить пользователям модальный всплывающий модуль, называемый модулем задач в Teams. Модуль задач собирает или отображает сведения, обрабатывает взаимодействие и отправляет информацию обратно в Teams. В этом документе приводятся инструкции по выбору расположения команд действий, созданию модуля задач, отправке окончательного сообщения или карточки, созданию команды действий с помощью студии приложения или созданию его вручную. 
...
* **Статический список параметров.** Это самый простой метод. Вы можете определить список параметров в манифесте клиента Teams, но в данном случае не можете управлять форматированием.
