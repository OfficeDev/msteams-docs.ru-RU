...
* Нет ответа. Используйте действие отправки, чтобы вызвать процесс во внешней системе и не предоставлять пользователю никаких отзывов. Это полезно для длительных процессов и предоставлять обратную связь поочередно. Например, вы можете дать обратную связь с помощью [активного сообщения.](~/bots/how-to/conversations/send-proactive-messages.md)
...
* [Запрос пользователя для предоставления дополнительной конфигурации.](~/get-started/first-message-extension.md)
