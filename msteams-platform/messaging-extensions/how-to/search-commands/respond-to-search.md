...
Чтобы отправить адаптивную карту или Office 365 соединителю, необходимо включить предварительный просмотр. Свойство `preview` должно быть карточкой Hero или Thumbnail. Если не указать свойство предварительного просмотра в объекте, предварительный просмотр `attachment` не создается.
