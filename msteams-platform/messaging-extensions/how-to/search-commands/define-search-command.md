...
* Командный окне: @mentioning в командном окне.
...
Следуйте [пошаговом руководстве](../../../sbs-messagingextension-searchcommand.yml) по созданию расширения обмена сообщениями на основе поиска.
