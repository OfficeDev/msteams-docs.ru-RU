...
> [!NOTE]
> Если в списке собраний или группового чата есть Федеративные пользователи, Teams подавляет доступ к расширениям обмена сообщениями для всех пользователей, в том числе организатора.
