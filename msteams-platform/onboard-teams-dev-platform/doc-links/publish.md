...
---
# <a name="understanding-the-appsource-submission-process"></a>Общие сведения о процессе отправки AppSource

## <a name="teams-app-submission"></a>Отправка приложений Teams

Публикация приложения в [Microsoft AppSource](https://appsource.microsoft.com) делает его доступным в каталоге приложений Teams и в Интернете. На высоком уровне процесс отправки приложения в AppSource:
