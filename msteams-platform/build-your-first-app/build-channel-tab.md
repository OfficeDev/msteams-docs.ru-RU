...
* **Страница "Конфигурация** ": диалоговое окно для добавления вкладки в канал или чат. (В App Studio можно найти эту страницу, перейдя на **вкладки > вкладке Группа** ).
...
У каждой вкладки в канале или чата есть страница конфигурации, в которой по крайней мере один вариант установки, отображаемый при добавлении приложения пользователями. По умолчанию на странице конфигурации запрашиваются пользователи, хотят ли они уведомлять канал или чат при установке вкладки.
...
1. Вернитесь в Teams. В диалоговом окне выберите команду **Добавить в группу** или **Добавить в чат** , а затем выберите канал или чат, который вы можете использовать для тестирования.
1. Выберите **Настройка вкладки**. Страница конфигурации отображается в диалоговом окне.<br/>
