...
---
# <a name="build-your-first-channel-and-group-tab-for-microsoft-teams"></a>Создайте вкладку первого канала и группы для Microsoft Teams
...
Этот Microsoft Teams набор средств позволяет настроить приложение и настроить леса, соответствующие вкладке канала и группы. В нем также содержится базовая страница конфигурации и страница контента, на которую отображается "Hello, World!". Сообщение.
...
1. Во входе в Microsoft 365 учетной записи разработки при запросе на это.
...
1. Выберите **вкладку Групповой или Teams канала**.
...
* **Строительные** леса приложений. Строительные леса приложений предоставляют компоненты, необходимые для отрисовки вкладки канала в Teams. Тем не менее, вы можете много работать, но теперь давайте сосредоточимся на следующем:
  ...
  * Microsoft Teams Клиент JavaScript SDK, который поставляется с предварительной загрузкой в конечные компоненты проекта.
...
## <a name="7-sideload-your-app-in-teams"></a>7. Перезагрузите приложение в Teams
...
1. Откройте веб Teams клиента в Visual Studio Code с помощью **клавиши F5.**
1. Добавление `localhost` () в качестве надежного, следуя этим шагам, чтобы включить отображение контента приложения в Teams:
...
1. Выберите **Добавить в команду или** **добавить** в чат и найти канал или чат, который можно использовать для тестирования из модального Teams.
...
* [Разработка вкладки для Microsoft Teams рабочего стола и веб-страницы](../tabs/design/tabs.md) 
