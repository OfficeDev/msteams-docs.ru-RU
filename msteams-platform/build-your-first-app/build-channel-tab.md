...
---
# <a name="build-a-teams-channel-tab"></a>Создание вкладки "канал Teams"
...
> [!div class="checklist"]
>
> * Определение некоторых свойств манифеста приложения и формирование шаблонов, связанных с вкладками канала
