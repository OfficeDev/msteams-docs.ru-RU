...
У людей в вашей организации есть проблемы с поиском основных контактных данных для важных функций (службы поддержки, отдела кадров и т. д.). Вы отвечаете за то, чтобы они могли быстро найти эти сведения в одном месте. Как это сделать? Конечно, личная вкладка Teams.
...
Скафолдинг приложения предоставляет компоненты для отображения личной вкладки в Teams. Вы можете работать с большим количеством экономий, но на данный момент вам нужно сосредоточиться только на следующих:

* `Tab.js` файл в `src/components` каталоге проекта. Это делается для отображения страницы содержимого вкладки.
...
Хорошие приложения отлично работают с Teams, поэтому важно, чтобы ваша вкладка смешивала тему Teams, предпочитаемую вашими пользователями: по умолчанию (светлая), темная или высокая контрастность. Как вы могли заметить на последнем снимке экрана, на вкладке по-прежнему имеется светлый фон, когда клиент использует темную тему. Это не рекомендуется для пользователей.
...
* [Встраивайте](../tabs/how-to/add-tab.md#tab-requirements)содержимое из существующего веб-приложения или веб-страницы: мы показали вам, как создать новое содержимое для личной вкладки, но вы также можете загрузить содержимое с внешнего URL-адреса.
