...
В Teams есть два типа вкладок. В этом руководстве вы создайте базовую *личную* вкладку — полноэкранную страницу содержимого для отдельных пользователей. (Личные вкладки — это самое близкое к традиционному веб-сайту в Teams.)
...
В наборе средств перейдите в **App Studio,** чтобы просмотреть и обновить конфигурации приложений.
...
> [!NOTE]
> В следующем примере вы можете применять стили к вкладке только одним способом. Используйте код как есть, раз expand on it или write your own.
...
* Использование данных Teams с [Microsoft Graph.](https://docs.microsoft.com/graph/teams-concept-overview)
* [Создайте вкладку без наборов средств.](../tabs/quickstarts/create-personal-tab-node-yeoman.md)
