...
Строительные леса приложений предоставляют файл, расположенный в корневом каталоге вашего проекта, является обработщиком Teams, который обрабатывает действия бота, например, как бот реагирует на определенные `botActivityHandler.js` сообщения.
